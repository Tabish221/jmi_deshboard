        ...
        if(fputs($ptr,"WUSERINFO-login=$account->account_id|password=$account->password\nQUIT\n"))
          {
           ...
           while(!feof($ptr))
            ...
            if( Request::segment(1) =='ar'){
                ...
                $title = "Control Panel | Account Overview 1";
                return view('cpanel.home1',compact('title','user','notifications_all','notifications_unseen','accounts','equities','names','balances'));
            }
