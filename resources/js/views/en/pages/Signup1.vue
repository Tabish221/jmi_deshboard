                    ...
                    <div class="signup-main">
                        ...
                        <div class="signup-form">
                            <form id="RegisterForm"  method="post" @submit.prevent="handleSignup" class="registration-form">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="signupd-feild">
                                            <label for="title">Full Name</label>
                                            <div class="d-flex">
                                                <select class="" name="title" v-model="form.title"  id="title">
                                    ...
                                    <div class="col-md-8">
                                        <div class="signupd-feild">
                                            ...
                                            <input  type="text" class="" v-model="form.fullname" id="fullname" name="fullname" placeholder="Full Name *" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-8">
                                        <div class="signupd-feild">
                                            ...
                                            <input type="email" name="email" placeholder="Email :"   v-model="form.email"  class="form-email" id="email" required>
                                    ...
                                    <div class="col-md-4">
                                        <div class="loginForm-btn signupd-feild">
                                            <label for="email_send_code1">&nbsp;</label>
                                            <button type="button"  id="email_send_code1"  style="height: 60px;padding: 10px;" @click="emailSendAuth()">Send Code</button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="loginForm-btn signupd-feild">
                                            <button type="button" id="email_verify_code"  style="height: 60px;padding: 10px;display:none;" @click="emailcodeverify()" >Verify code</button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="signupd-feild loginForm-btn ">
                                            <label for="">&nbsp;</label>
                                            <button type="button"  id="send_code1"  style="height: 60px;padding: 10px;" @click="phoneSendAuth()" >Send Code</button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="signupd-feild loginForm-btn ">
                                            <button type="button" id="verify_code" @click="codeverify();"  style="height: 60px;padding: 10px; display:none;">Verify code</button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="signupd-feild">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <button class="btnEye" @click="toggleEye('password')" type="button"><i id="open" class="">show</i> <i id="close" class="">hide</i></button>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="signupd-feild">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <input  type="password" class="form-control1" placeholder="Confirm Password *" v-model="form.confirmpassword" id="confirmpassword" name="confirmpassword" required>
                                                <button class="btnEye" @click="toggleEye2('confirmpassword')" type="button"><i id="open2" class="">show</i> <i id="close2" class="">hide</i></button>
                                            </div>
                                        </div>
                                    </div>

                                    <div id="recaptcha-container mb-3" ></div>

                                    <div class="col-md-12">
                                        <!-- <div class="signupd-agree">
                                            <div class="">
                                        ...
                                        <div class="loginForm-btn">
                                            <button type="submit" class="submit" id="register1" disabled>SignUp Now</button>
                                        </div>
