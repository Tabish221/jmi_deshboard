...
<table width="680" border="0" align="center">
  <tr>
     ...
     <table width="680" height="37" border="0" background="/assets/cimages/bg_1.jpg">
        <tr>
          <td><span ><strong>&nbsp;&nbsp;&nbsp;&nbsp;Support &amp; Resistance</strong></span></td>
        </tr>
      </table>
      <br />
      ...
      <h2 >What They are and How to Use Them for High-Impact Results: </h2>
      <p>Using two moving averages - one of shorter length and one of longer length -  to generate trading signals is commonly used among traders today. This method,  known as the "double crossover method," is especially suited for securities  that happen to be in trending, as opposed to range-bound markets. (Trending  markets are characterized by steady upward price movement in bull markets and  steady downward price movement in bear markets. Prolonged sideways movement  with little sustained progress up or down is characteristic of "range bound"  markets.) <br />
