...
<table width="680" border="0" align="center">
  <tr>
    <td>
     ...
     <table width="680" height="37" border="0" background="/assets/cimages/bg_1.jpg">
        <tr>
          <td><span ><strong>&nbsp;&nbsp;&nbsp;&nbsp;The Foundations of Gann Theory</strong></span></td>
        </tr>
      </table>
      </div>
      <br />
  ...
  &quot;Through the Law of Vibration every stock in the market moves in its  own distinctive sphere of activities, as to intensity, volume and direction;  all the essential qualities of its evolution are characterized in its own rate  of vibration. Stocks, like atoms, are really centers of energies, therefore  they are controlled mathematically. Stocks create their own field of action and  power; power to attract and repel, which in principle explains why certain  stocks at times lead the market and 'turn dead' at other times. Thus to  speculate scientifically it is absolutely necessary to follow natural  laws.&quot;</p>
      ...
      <p>Gann possessed an extraordinary gift for mathematics. He was a mathematician  by nature, so it only followed that much of his technical theory should be  concerned with numbers and with mathematical relationships in the markets.  Certain numbers took on a special significance in his work, namely, 16, 25, 36,  49, 64, 121, and 144. His numerical theory of the market was based on his study  of the Bible, along with ancient Egyptian number theory.<br />
        ...
        The number 144 (which is a product of 12 times 12) was also important for  Gann, the number also representing the number of minute in a day (1441, with  zero at the end being disregarded). The number 144 also recurs throughout the  Bible, and therefore took on an even greater significance for him.<br />
        Based on his many years of studying number theory, then, he concluded that  markets adhere to mathematical law. From this conclusion he was able to develop  his trading theory. This theory basically stated that market movement is  governed by the forces of pattern, price, and time.</p>
      <h2 >Time: The Strongest Market Influence</h2>
      <p>According to Gann, time had the strongest influence on the market because  when time is up, the trend changes. Concerning the importance Gann assigned to  the time factor, consider the following Gann quote, in reference to his  analysis of the October Eggs futures contract:<br />
...
export default ({
    data(){
        return{
            site_title: `The Foundations of Gann Theory`,
            site_description: ``,
            site_keywords: '',
