<template>
<link rel="canonical" href="https://www.jmibrokers.com/en/dailyfundamental " />
                    ...
                    <div id='post' class='col-sm-12'>
                        ...
                        <div class='right col-sm-9'>
                            <div id='title' style='text-align:left;margin-bottom:20px;height:80px;' class='col-sm-12'>
                                <a style='font-size:20px;' :href="`/en/dailyfundamental/fundamental/${post.id}`">{{ post.title }}</a>
                            </div>
                            ...
                            <div id='time' style='color:#fff;text-align:center;padding-right:20px;' class='col-sm-12'>
                                <a :href="`/en/dailyfundamental/fundamental/${post.id}`">...Read More...</a>
