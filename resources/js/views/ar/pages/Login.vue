                ...
                <div class="login pdtb40" dir="rtl">
                    ...
                    <form id="" autocomplete="off" method="post" @submit.prevent="handleLogin"   class="form-horizontal" >
                        ...
                        <div class="input-container">
                            <input name="username" type="text" v-model="form.username" placeholder="اسم المستخدم او الايميل" class="txt-box" required/>
                        </div>
                        <div class="input-container">
                            <input id="myPass" name="password" type="Password" v-model="form.password" placeholder="كلمة السر :" class="txt-box" required />
                    ...
                    <p class="text-center" style="display: block;">نسيت<a href="/ar/forgot-password"> كلمة السر</a>؟</p>
                    <p class="text-center" style="display: block;">ليس لديك حساب؟<a href="/ar/signup">تسجيل الدخول</a></p>
        ...
        const handleLogin = async () => {
            ...
            try {
                ...
                if (result.status === 200 && result.data) {
                    ...
                    $("#Error").text(result.data.errors.ar);
                    $("#Error").show();
                    $("#Success").hide();
                }
            } catch (e) {
