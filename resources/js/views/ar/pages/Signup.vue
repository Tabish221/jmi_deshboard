        ...
        <div class="container">
            <div class="row pdtb40">
                ...
                <div class="myFlex">
                    ...
                    <div class="col-lg-4 col-md-5 col-sm-6 col-xs-12 col-lg-push-8 col-md-push-6 col-sm-push-6  col-xxs text-right" >
                        <div id="newLogin">
                        ...
                        <form id="RegisterForm"  method="post" @submit.prevent="handleSignup" class="registration-form">
                            ...
                            <div class="control-group">
                                ...
                                <div class="col-sm-9 padding-right-0 ">
                                    <div class="controls">
                                        <input  type="text" class="form-control  " v-model="form.fullname" id="fullname" name="fullname" placeholder="الأسم بالكامل *" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8 col-sm-push-4" >
                                    <input type="email" name="email" placeholder="الأيميل :"   v-model="form.email"  class="form-email form-control" id="email" required>
                                </div>
                                <div class="col-sm-4 col-sm-pull-8" >
                                    <button type="button"  id="email_send_code"  class="btn btn-success" @click="emailSendAuth()">أرسل الكود</button>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8 col-sm-push-4">
                                    <input type="number" id="emailverificationCode"  v-model="form.emailverificationCode" name="emailverificationCode" class="form-control" placeholder="ادخل كود التفعيل" style="display:none;" required>
                                </div>
                                <div class="col-sm-4 col-sm-pull-8" >
                                    <button type="button" id="email_verify_code"  class="btn btn-success" @click="emailcodeverify()"  style="display:none;">تفعيل الأن</button>
                                </div>
                            ...
                            <div class="form-group">
                                <input type="text" name="username"  v-model="form.username"  placeholder="اسم المستخدم - بدون مسافات"    class="form-email form-control" id="username" required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="number" id="number" v-model="form.phone_number"  class="form-control" name="phone_number" placeholder="رقم التليفون" required>
                                </div>
                                <div class="col-sm-4">
                                    <button type="button"  id="send_code"  class="btn btn-success" @click="phoneSendAuth()" >أرسل الأن</button>
                                </div>
                            </div>
                            <div class="form-group">

                                <div class="col-sm-8 col-sm-push-4">
                                    <input type="number" id="verificationCode" class="form-control"  placeholder="ادخل كود التفعيل" style="display:none;" required>
                                </div>
                                <div class="col-sm-4 col-sm-pull-8">
                            ...
                            <div class="control-group">
                                ...
                                <div class="col-sm-6 padding-left-0">
                                    <div class="controls input-container">
                                        <input  id="password" type="password" class="form-control " v-model="form.password"  placeholder=" كلمة السر *"  name="password" required>
                                ...
                                <div class="col-sm-6 padding-right-0 ">
                                    <div class="controls input-container">
                                        <input  type="password" class="form-control  " placeholder="تأكيد كلمة السر *" v-model="form.confirmpassword" id="confirmpassword" name="confirmpassword" required>
                            ...
                            <button type="submit" class="btn btn-success submit" id="register" disabled>سجل الأن</button>
                        </form>
...
// Initialize Firebase
        ...
        codeverify() {
            ...
            this.coderesult.confirm(code).then(function (result) {
                ...
                $("#SuccessVerify").text("تم التفعيل بنجاح - يمكنك المتابعة");
                $("#SuccessVerify").show();
                $("#Success").hide();
            ...
            $.ajax({
                ...
                success:function(result){
                    if(result==1){
                        ...
                        $("#emailsentSuccess").text("تم الارسال بنجاح");
            ...
            $.ajax({
                ...
                success:function(result){
                    if(result==1){
                        ...
                        $("#emailsuccessRegsiter").text("تم التفعيل بنجاح - يمكنك المتابعة");
        ...
        phoneSendAuth(){
            ...
            auth.signInWithPhoneNumber(number,window.recaptchaVerifier).then( (confirmationResult) => {
                ...
                $("#SMSSuccess").text("تم الأرسال بنجاح.");
                $("#SMSSuccess").show();
        ...
        const handleSignup = async () => {
            ...
            try {
                ...
                if (result.status === 200 && result.data==1) {
                    ...
                    await router.push('/ar/cpanel/home')
                }
            } catch (e) {
