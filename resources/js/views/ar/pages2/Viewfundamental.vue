<template>
        ...
        <div class="container">
            ...
            <p style='font-size:22px;color:#0059b2;text-align:left;font-weight:bold;' >{{ this.fundamentalanalysis.arabic_title }}</p>
                                <div id='post' class='col-sm-12'>
                                    <div class='col-sm-12'>
                                        ...
                                        <div id='details' style='font-size:16px;margin-bottom:20px;color:#fff;height:auto;text-align:left;' class='col-sm-12'>
                                            <div v-html="`${this.fundamentalanalysis.arabic_details}`"></div>
                                        </div>
        ...
        async getData() {
            ...
            try {
                ...
                if (result.status === 200) {
                    ...
                    this.site_title=result.data.error.ar;
                }
