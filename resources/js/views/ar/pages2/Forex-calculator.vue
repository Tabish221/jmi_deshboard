<template>
        ...
        <div class="container">
            <div class="row gray_bg mrtb40">
                ...
                <iframe _ngcontent-sc299="" id="all-in-one-calculator" width="100%" frameborder="0" scrolling="no" height="auto" src="https://widgets-m.fxpro.com/ar/calculators/all-in-one/9" style="min-height:500px;"></iframe>
            </div>
