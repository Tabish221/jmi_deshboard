<template>
  ...
  <tr>
    <td>
    <div class="table-responsive">
    <table width="680" height="37" border="0" align="center">
        <tr>
          <td background="html/cimages/bg_1.html"><span class="style53"><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Forex vs. Equities</h2></span></td>
        </tr>
      </table></div>
      <p class="style54">
        <br />
      Forex Advantages  </p>
      <p>Investors and speculators using the  Internet as an investment tool will find that the Forex market </p>
      <p>offers several  advantages over equities trading. </p>
      <p align="center"><img src="/assets/cimages/untitledgnhgf.jpg" /></p>
      <p>*200:1 is the entry leverage value.  Brokerages will have margin calls set at different levels, exact leverage may  vary. <br />
*The trader's cost of doing  business is called the Spread. It is the difference between the bid and the ask  prices on your chosen currency pair. </p>
    <p>&nbsp;</p>
    <p class="style55">24-Hour  Trading</p>
    <p>Forex is a true 24 hour market, 5.5  days a week, which offers a major advantage over equities trading. Investors  are able to trade at odd hours, thus allowing more flexibility for personal,  business and social activities. Whether trading at 8am, 2pm, or even 2am, there  will always be buyers and sellers actively trading foreign currencies. Such  flexibility allows traders to immediately respond to breaking news and other  political factors driving the market. </p>
    <p align="center"><img src="/assets/cimages/mngjy.jpg" /></p>
    <p>After hours trading in the equities  market has several limitations. In the US, for example, equities traders have  access to ECNs (Electronic Communications Networks), also known as "matching  systems". These networks are established to provide a method for equities  traders to buy and sell amongst each other. Such networks are usually not able  to offer as tight of spreads as would be offered during normal market hours,  thus most trades are not executed at a fair market price, subsequently there is  no guarantee that every trade will be executed. </p>
    <p class="style56">Unmatched  Liquidity</p>
    <p>An investment market with lacking  liquidity, or a lack of buyers and sellers at certain times, is often the  demise of traders who need in or out of the market without delay. The global  network of governments, banks, corporations, hedge funds, and individual  traders that collectively drive the Forex market, are in essence, also driving  the world's largest network of liquidity. Such high trade volume works to  ensure trade execution and the stability of prices, regardless of the time of  day. <br />
      Equities traders, on the other hand,  are more susceptible to liquidity risk and are subject to potentially wider  dealing spreads and larger price movements. Liquidity in the equities market  really does pale in comparison to that of the Forex market. </p>
    <p><strong>&nbsp;</strong></p>
    <p><span class="style57"><strong>&nbsp;</strong><strong>High  Leverage</strong></span></p>
    <p>Leverage is the key to understanding  the risk associated with trading the Forex Market, and of course, the potential  for gain. Many Forex brokers offer leverage as high as 200 - 1, meaning that  $50 of margin would control a $10,000 position in the market (this is an  example of a mini lot).</p>
    <p align="center"><img src="/assets/cimages/cfgfdg.jpg" /></p>
    <p>Forex trading is often attractive to  investors coming from the equities market because Forex trading offers such  high leverage. It is important to understand why Forex brokers offer higher  leverage, and of course... the dangers associated with such. <br />
