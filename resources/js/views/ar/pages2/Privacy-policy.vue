...
<p>JMI Brokers places a high priority on the privacy and integrity of the personal information of our
...
and in the case of changes to the service by authorized representatives of the company.</p>

<h4>The Client's Personal Data</h4>

<p>To open a demo or live account, the Company will need certain information (Personal Data) about the
Client.</p>

<h4> The Personal Data that is collected by the Company may include:</h4>
<ul>
<li>
...
<li> 1. to confirm the Client's identity;</li>
<li> 2. to process trading and non-trading operations;</li>
<li> 3. carry out the company's anti-money laundering policy;</li>
<li> 4. to inform the Client of Company products or services that may be of interest to the Client;</li>
<li> 5. to provide other services that are relevant to the Client's business relationship with the Company;</li>
<li> 6. to keep a correct database of the Client’s account data;</li>
<li> 7. to analyze statistical data to provide Clients with the most suitable products and services.</li>

</ul>

<h4>Cookies</h4>

<p>Cookies are small text files sent by a web server and stored on a visitor's browser which are read later by the
...
anyone visiting the site.</p>

<h4>Third Parties</h4>

<p>The Company may convey the Client's Personal Data to associated or affiliated companies, auditors, agents
...
partners, agents or affiliates only when requested by representatives of legal or administrative authorities.</p>

<h4>Use of Information</h4>
<p>By registering an account with the Company, you consent to the use of your personal details, and their3
...
<p>JMI Brokers takes the issue of security very seriously and takes all possible measures to ensure the safety of your
...
unauthorized use of your credit/debit card, your card information is transmitted to JMI Brokers in shortened form
and through a secure server.</p>
