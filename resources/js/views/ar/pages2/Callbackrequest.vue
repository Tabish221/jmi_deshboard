    ...
    <div class="callbackrequest loginpage">
        <div class="container">
            <div class="col-lg-6 col-sm-8 col-xs-12 col-xxs" >
                ...
                <div class="login">
                    <div class="title text-right  color-white" >
                        <h1> طلب  <strong> اتصال </strong></h1>
                        <div class="form" dir="rtl">
                             <form id="callbackrequest" autocomplete="off" method="post" @submit.prevent="callback" class="form-horizontal">
                                ...
                                <div class="control-group col-sm-12">
                                  ...
                                  <div class="col-sm-9">
                                    <div class="controls">
                                        <input  type="text" class="form-control txt-box col-lg-8" id="fullname" v-model="form.fullname" name="fullname"  placeholder="الأسم بالكامل *"  required>
                                    </div>
                                  </div>
                                </div>
                                <div class="control-group col-sm-12">
                                ...
                                <div class="col-sm-6">
                                    <div class="controls">
                                      <input   type="text" class="form-control txt-box" id="email" name="email" v-model="form.email"  placeholder="الأيميل *"  required>
                              ...
                              <select name="country" title="أختر الدولة!" v-model="form.country" id="country" class="form-control txt-box"   required>
                                  <option disabled selected>--أختر الدولة --</option>
                              ...
                              <option value="240">Zimbabwe</option>
                                          ...
                                          <div class="col-sm-6">
                                            <div class="controls">
                                                <input  type="text" class="form-control txt-box col-lg-8" v-model="form.city" id="city" name="city"  placeholder="المدينة *"  required>
                                            </div>
                                          </div>
                                        </div>
                                        <div class="control-group col-sm-12">
                                            ...
                                            <div class="col-sm-5">
                                              <div class="controls">
                                                <input  type="text" class="form-control txt-box col-lg-8" v-model="form.code" id="code" name="code" placeholder="كود الدولة * : use 00 for +"   required>
                                              </div>
                                          </div>
                                            <div class="col-sm-7">
                                              <div class="controls">
                                                <input  type="text" class="form-control txt-box col-lg-8" id="phone" v-model="form.phone" name="phone"  placeholder="التليفون *" required>
                                              </div>
                                          </div>
                                            ...
                                            <div class="col-sm-12" >
                                              <div class="col-sm-12">
                                               <input type="text" class="form-control txt-box" name="timetocall" v-model="form.timetocall" id="timetocall" placeholder="أوقات الأتصال * : Ex. 9 AM to 6 PM" required/>
                                              </div>
                                            </div>
        ...
        const callback = async () => {
            ...
            try {
                ...
                if (result.status === 200) {
                    await router.push('/ar/callbackrequest/msg')
