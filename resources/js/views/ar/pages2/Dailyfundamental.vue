<template>
<link rel="canonical" href="https://www.jmibrokers.com/ar/dailyfundamental " />

	<div class="row">
			<div class="container">
                <h1>التحليل الأساسى</h1>
                    ...
                    <div id='post' class='col-sm-12'>
                        ...
                        <div class='right col-sm-9'>
                            <div id='title' style='text-align:left;margin-bottom:20px;height:80px;' class='col-sm-12'>
                                <a style='font-size:20px;' :href="`/ar/dailyfundamental/fundamental/${post.id}`">{{ post.title }}</a>
                            </div>
                            ...
                            <div id='time' style='color:#fff;text-align:center;padding-right:20px;' class='col-sm-12'>
                                <a :href="`/ar/dailyfundamental/fundamental/${post.id}`">...المزيد...</a>
