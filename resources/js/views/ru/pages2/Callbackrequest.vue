                        ...
                        <div class="form">
                             <form id="callbackrequest" autocomplete="off" method="post" @submit.prevent="callback" class="form-horizontal">
                                ...
                                <div class="control-group col-sm-12">
                                  ...
                                  <div class="col-sm-9">
                                    <div class="controls">
                                        <input  type="text" class="form-control txt-box col-lg-8" id="fullname" v-model="form.fullname" name="fullname"  placeholder="Полное имя *"  required>
                                    </div>
                                  </div>
                                </div>
                                <div class="control-group col-sm-12">
                                ...
                                <div class="col-sm-6">
                                    <div class="controls">
                                      <input   type="text" class="form-control txt-box" id="email" name="email" v-model="form.email"  placeholder="Электронная почта *"  required>
                              ...
                              <option value="240">Zimbabwe</option>
                                          ...
                                          <div class="col-sm-6">
                                            <div class="controls">
                                                <input  type="text" class="form-control txt-box col-lg-8" v-model="form.city" id="city" name="city"  placeholder="Город *"  required>
                                            </div>
                                          </div>
                                        </div>
                                        <div class="control-group col-sm-12">
                                            ...
                                            <div class="col-sm-7">
                                              <div class="controls">
                                                <input  type="text" class="form-control txt-box col-lg-8" id="phone" v-model="form.phone" name="phone"  placeholder="Телефон *" required>
                                              </div>
                                          </div>
        ...
        const callback = async () => {
            ...
            try {
                ...
                if (result.status === 200) {
                    await router.push('/ru/callbackrequest/msg')
