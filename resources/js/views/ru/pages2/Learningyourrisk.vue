<template>
  ...
  <tr>
    <td><p class="style18 style20">Learning Your Risk Tolerance</p>
    <p>The secret to successful investing is learning your own style, or in other  words trading method(s) that work for you. There is no correct approach that  everyone should learn. However, every trader needs to assess how much risk they  can comfortably handle. It is the single most important investment issue for  long-term success in the Forex market. <br />
...
- What is risk?<br />
- The different types of risk<br />
- The risk/Return Balance<br />
- Diversifying your trading</p>


     <table width="680" height="37" border="0" background="/assets/cimages/bg_1.jpg">
        <tr>
          <td><span ><strong>&nbsp;&nbsp;&nbsp;&nbsp;What is Risk?</strong></span></td>
        </tr>
      </table>
      <br />


    <p>Whether it is investing, driving, flying, swimming, or just walking down the  street, everyone exposes themselves to risk. Your personality and lifestyle  play a big role on how much risk you are comfortable with. For most investors,  risk simply means &quot;losing money.&quot; But if your investment choices  leave you unable to sleep at night you are probably taking on too much risk. <br />
The dictionary's definition of risk is &quot;The variability of returns from  an investment or the chance that an investment's actual return will be  different than expected. This includes the possibility of losing some or all of  the original investment. It is usually measured using the historical returns or  average returns for a specific investment. The greater the variability of an  investment (i.e. fluctuation in price or interest), the greater the risk.&quot; <br />
The enhanced daily price movements and the leverage available in the Forex  market compared to other financial instruments like stocks is the reason the  Forex market is categorized as a &quot;high risk investment vehicle&quot;. As  investors are generally averse to risk, investments with greater inherent risk  must promise higher expected yields to warrant taking on additional risk.  Others add that higher risk means a greater opportunity for high returns or a  higher potential for loss. However a higher potential for return doesn't always  mean that it must have a higher degree of risk. This is why identifying and  adhering to a strict trading strategy is so important to the overall  performance. Learn more about use of proper money management to minimize your  risk exposure. Do you have a hard time giving money back to the market when you  feel that you have worked so hard for every penny of profit? If so, you would  find yourself amongst the &quot;risk adverse&quot; category of investors. On  the other hand, super active day traders feel most comfortable making dozens of  trades per day and are considered &quot;risk loving&quot;. When investing in  currencies, stocks, bonds, commodities, futures or any investment instrument  there is a lot more risk than most investors think. Learn more about the  different types of risk that effect your Forex trading. </p>
    <p>&nbsp;</p>
    <h2 >The Different Types of Risk</h2>
    <p>There are two basic classifications of risk: Systematic Risk - A risk that  influences a large number of currency pairs. Examples of systematic risk are  global political events, natural disasters, or war. Unsystematic Risk -  Sometimes referred to as &quot;specific risk&quot;. Its risk affects a very  small number of currencies and currency pairs. An example is economic news that  affects a specific country or region, such as a sudden strike by employees or a  change in the Canadian interest rate. Diversification across multiple  non-related currency pairs is the only way to truly protect yourself from  unsystematic risk. <br />
Now that we've determined the two main classifications of risk lets take a  closer look at more specific types of risk. <br />
<strong><em>Default Risk</em></strong> - This is the risk that the company with whom you  have your Forex trading account will be unable to pay out an investor's account  balance when a withdrawal request is submitted. Many Forex traders remember the  incident of Refco in the fall of 2005. Unfortunately Refco, one of the world's  largest investment firms with brokerage arms within commodities, futures and  forex filed for bankruptcy protection and each of the brokerages were auctioned  off to competitors or former subsidiaries. Their clients were unable to  withdraw profits and initial capital until the brokerages were sold off. As of  yet the dust has not settled and it is still too early to tell if all former  customers received complete compensation. Choosing a suitable, stable broker is  more than choosing the biggest. <br />
<strong><em>Country Risk</em></strong> -This refers to the risk that a country won't be  able to honor its financial commitments. When a country defaults it can harm  the performance of all other financial instruments in that country as well as  other countries it has relations with. Country risk applies to stocks, bonds,  mutual funds, options, futures and most importantly the currency that is issued  within a particular country. This type of risk is most often seen in emerging  markets or countries that have a severe deficit. <br />
<strong><em>Forex Risk</em></strong> - When investing in foreign currencies you must  consider that the currency exchange rate fluctuations of closely linked  countries can drastically move the price of the primary currency as well. For  example, economic and political events directly tied to the British Pound (GBP)  have an effect on the Euro's trading (i.e. the EUR/USD might have similar  reaction as GBP/USD even though they are both separate currencies and are not  in the same currency pair). Knowing what countries effect the currency pairs  you trade is vital to your long-term success. <br />
<strong><em>Interest Rate Risk</em></strong> - A rise or decline in interest rates  during the term a trade is open will affect the amount of interest you might  pay per day until the trade is closed. Open trades at rollover are assessed  either an interest charge or interest gain depending upon the direction of the  open trade and the interest rate levels of the corresponding countries. If you  sell the currency with the higher interest rate you will be charged daily  interest at the time of rollover based on your broker's rollover/interest  policy. For more specifics on understanding your interest risk, please consult  your broker for complete details of their policy including time of rollover,  interest price (also called swap) and account requirements to receive interest  paid to your account. <br />
<strong><em>Political/Economic Risk</em></strong> - This represents the risk that a  country's economic or political events will cause immediate and drastic changes  in the currency prices associated with that country. Another example of this  risk is government intervention that we typically see with Japan and the need  to maintain low currency prices to bolster their exports. <br />
<strong><em>Market Risk</em></strong> - This is the most familiar of the risks we have  discussed, and according to some, really the main risk to consider. Market risk  is the day to day fluctuations in a currency pair's price; also referred to as  volatility. Volatility is not so much a cause but an effect of certain market  forces. Volatility is a measure of risk because it refers to the behavior, or  &quot;temperament,&quot; of your investment rather than the reason for this  behavior. Because market movement is the reason why people can make money,  volatility is essential for returns, and the more unstable the currency pair  the higher the chance it can go dramatically either way. <br />
<strong><em>Technology Risk</em></strong> - This is a particular risk that many traders  don't think much about. However, with the majority of individual Forex traders  executing trades online, we are all technology reliant. Are you protected  against technology failure? Do you have an alternative internet service? Do you  have back-up computers that you could use if your primary trading computer  crashes? <br />
As you can see, there are several types of risk that a smart investor should  consider and pay careful attention to in their trading. Deciding your potential  return (target profit) while respecting risk is the age old decision that each  investors must make </p>
    <h2 >The Risk Reward Balance</h2>
    <p>The risk/return balance could easily be called the iron stomach test.  Deciding what amount of risk you can take on while allowing yourself to walk  away from your computer without worrying and to get sound rest at night while  you have long-term trades open is a trader's foremost important decision. The  risk/return balance is the balance a trader must decide on between the lowest  possible risk for the highest possible return. Remember to keep in mind that  low levels of uncertainty (low risk) are associated with low potential returns  and high levels of uncertainty (high risk) are associated with high potential  returns. Trading is all about risk and probabilities. Understanding the inner  functions of your trading strategy(s) and proper placement of entry and exit  orders will assist in limiting your risk exposure while maximizing your profit  potential. <br />
