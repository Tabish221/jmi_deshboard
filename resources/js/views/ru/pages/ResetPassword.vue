    ...
    <div class="container">
        <div class="col-sm-4">
            ...
            <form id="resetpassword" autocomplete="off" method="post" @submit.prevent="handleForgotPassword" class="form-horizontal">
                ...
                <input name="newpassword" type="password" v-model="form.newpassword" id="newpassword" placeholder="New Password :" class="form-control" /><br />
                <input name="confirmnewpassword" type="password" v-model="form.confirmnewpassword" id="confirmnewpassword" placeholder="Confirm Password :" class="form-control" /><br />
                <br />
        ...
        const handleForgotPassword = async () => {
            ...
            try {
                ...
                if (result.status === 200 && result.data) {
                    $("#Success span:first-child").text(result.data.message.ru);
                    $("#Success").show();
                    $("#Error").hide();

                }else if(result.status === 201){
                    $("#Error span:first-child").text(result.data.errors.ru);
                    $("#Error").show();
                    $("#Success").hide();
                }
            } catch (e) {
