        ...
        async getData(){
            try {
                ...
                if (result.status === 200 && result.data) {
                    this.reuters_news=result.data.data.ru.reuters_news
                    this.site_title=result.data.data.ru.title
                    this.site_description=result.data.data.ru.description
                    this.site_keywords=result.data.data.ru.keywords
                    useHead({
