                ...
                <div class="login pdtb40">
                    ...
                    <form id="" autocomplete="off" method="post" @submit.prevent="handleLogin"   class="form-horizontal" >
                        ...
                        <div class="input-container">
                            <input name="username" type="text" v-model="form.username" placeholder="Имя пользователя или адрес электронной почты" class="txt-box" required/>
                        </div>
                        <div class="input-container">
                    ...
                    <p class="text-center">Забыли свой<a href="/ru/forgot-password">пароль</a>?</p>
                    <p class="text-center">У вас нет аккаунта?<a href="/ru/signup">Завести аккаунт</a></p>
                </div>
            </div>
        ...
        const handleLogin = async () => {
            ...
            try {
                ...
                if (result.status === 200 && result.data) {
                    ...
                    $("#Error").text(result.data.errors.ru);
                    $("#Error").show();
                    $("#Success").hide();
                }
            } catch (e) {
