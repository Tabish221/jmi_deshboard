...
@section('content')
    ...
    {!! Form::open(['url'=>'ru/cpanel/withdraw-fund/webmoney'])  !!}
...
@if(count($accounts)>0)
                    ...
                    <div class="col-sm-8">
                        <div class="controls">
                            <select class="form-control" name="account_number" id="account_number" required >
                                ...
                                <option value="{!! $account->account_id !!}" >{!! $account->account_id !!} | реальный @if($account->account_type ==1) Individual Account @endif @if($account->account_type ==2) IB Account @endif</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
            ...
            <div class="col-sm-5 col-sm-push-1" >
                ...
                <div id="demoaccount">
                <img loading="lazy" src="/assets/cpanel/img/webmoney.png" alt="WebMoney"  class="max-width-100" />
                    <h3>WebMoney Снятие реквизитов</h3>
