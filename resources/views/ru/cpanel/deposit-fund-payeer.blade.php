...
@section('content')
    ...
    {!! Form::open(['url'=>'ru/cpanel/deposit-fund/payeer'])  !!}
...
@if(count($accounts)>0)
            ...
            <div class="col-sm-5 col-sm-push-1" >
                ...
                <div id="demoaccount">
                <img loading="lazy" src="/assets/cpanel/img/payeer.png" alt="Epay"  class="max-width-100" />
                    <h3>Payeer Детали финансирования</h3>
