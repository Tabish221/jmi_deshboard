...
@section('content')
    ...
    {!! Form::open(['url'=>'ru/cpanel/deposit-fund/fasapay'])  !!}
...
@if(count($accounts)>0)
            ...
            <div class="col-sm-5 col-sm-push-1" >
                ...
                <div id="demoaccount">
                <img loading="lazy" src="/assets/cpanel/img/fasapay.png" alt="Epay"  class="max-width-100" />
                    <h3>FasaPay Детали финансирования</h3>
