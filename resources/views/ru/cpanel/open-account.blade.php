...
<style>
        #main-section-6  {margin-bottom:10px;}
        #main-section-6 #section-6-title h1{font-size: 42px;font-weight: bold;font-family: Roboto-Bold;color: #0059b2;}
        #main-section-6 .package{height: 570px;padding: 30px 4px; margin:4px; background: #eeeeee;color:#0059b2;}
        ...
        #main-pricing-list{margin-bottom: 20px;}
        ...
        @media only screen and (max-width: 768px)
        {
            #main-section-6 .package{height: 550px;}
        }
...
@if(count($documents)< 1)
    <div class="alert alert-warning"  id="live-alert--0-" style-="display: none;">
       Чтобы открыть аккаунт, вы должны были утвердить 1 <a href="/ru/cpanel/documents"> документы</a>
    </div>
...
@if (count($live_accounts)>9)
    <div class="alert alert-warning " id="live-alert" style="display: none;" >
       Вы достигли максимально допустимого количества (10) реальных счетов
    </div>
@endif
@if (count($demo_accounts)>9)
    <div class="alert alert-warning"  id="demo-alert" >
       Вы достигли максимально допустимого количества (10) демо-счетов
    </div>
@endif
...
<?PHP if($customer_agreement == null){ ?>
  ...
  <div style="height: 300px;overflow-y: scroll;margin: 10px 20px;padding: 10px;">
    ...
    <div class="row" >
      <div class="col-sm-8" >
        <label class="col-sm-4">Подпись</label>
        <div class="col-sm-8 ">
            <div class="controls">
                 <input class="form-control" type="text" name="signature" id="signature" placeholder="Английская подпись" required/>
                 <label style="margin:5px 0px;"> <input type="checkbox" value="0" required/> Я согласен с условиями</label>
      ...
      <div class="col-sm-8 ">
          <div class="controls">
            <input type="number" class="form-control" name="account_radio_type" value="1" required style="display:none;"/>
               ...
               <input class="btn btn-success form-control" type="submit" id="submit" value="Открой счет" />
          </div>
      </div>
    </div>
    </div>
                 ...
                 <div class="uk-grid uk-flex uk-flex-center">
                     ...
                     <div class="col-sm-12" id="main-pricing-list">
                         ...
                         <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 margin-top-10" >
                                     <div class="package">
                                       <p class="minimum">Минимальное финансирование<span class="price">100 USD </span></p>
                                       <h2 class="title">Счет с фиксированным спредом</h2>
                                       <p class="desc">Воспользуйтесь лучшими в отрасли ценами на вход</p>
                                       <hr>
                                       <ul class="package-features-list package-features-list2">
                                           <li><i class="fa fa-check" aria-hidden="true"></i>1 фиксированный спред</li>
                                           <li><i class="fa fa-check" aria-hidden="true"></i>1:500 Кредитное плечо</li>
                                           <li><i class="fa fa-check" aria-hidden="true"></i>100$ Минимальное финансирование</li>
                                           <li><i class="fa fa-check" aria-hidden="true"></i>USD - основная валюта</li>
                                           <li><i class="fa fa-check" aria-hidden="true"></i>Исламский счет доступен</li>
                                           <li><i class="fa fa-check" aria-hidden="true"></i>Минимальный лот 0,01</li>
                                           <li><i class="fa fa-check" aria-hidden="true"></i>Советник</li>
                                           <li><i class="fa fa-check" aria-hidden="true"></i>Заголовок доступен</li>
                                           <li><i class="fa fa-check" aria-hidden="true"></i>4 цифры</li>

                                           <li class="false"><i class="fa fa-times" aria-hidden="true"></i>Скальпинг недоступен</li>
                                       </ul>
                                         <a val="1" class="btn btn-success uk-button uk-button-default uk-border-rounded uk-align-center">Выбрать сейчас</a>
                                     </div>
                                 </div>

                                 <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 margin-top-10" >
                                     <div class="package">
                                       <p class="minimum">Минимальное финансирование<span class="price">500 USD </span></p>
                                       <h2 class="title">счет с переменным спредом</h2>
                                       <p class="desc">Получайте еще более узкие спреды и комиссии</p>
                                       <hr>
                                       <ul class="package-features-list package-features-list2">
                                       <li><i class="fa fa-check" aria-hidden="true"></i>0.1 от спреда</li>
                                       <li><i class="fa fa-check" aria-hidden="true"></i>1:200 Кредитное плечо</li>
                                       <li><i class="fa fa-check" aria-hidden="true"></i>500$ Минимальное финансирование</li>
                                       <li><i class="fa fa-check" aria-hidden="true"></i>USD - основная валюта</li>
                                       <li><i class="fa fa-check" aria-hidden="true"></i>Исламский счет доступен</li>
                                       <li><i class="fa fa-check" aria-hidden="true"></i>Минимальный лот 0,01</li>
                                       <li><i class="fa fa-check" aria-hidden="true"></i>Советник</li>
                                       <li><i class="fa fa-check" aria-hidden="true"></i>Заголовок доступен</li>
                                       <li><i class="fa fa-check" aria-hidden="true"></i>5 цифры</li>

                                       <li class="false"><i class="fa fa-times" aria-hidden="true"></i>Скальпинг недоступен</li>
                                       </ul>
                                         <a val="3" class="btn btn-success uk-button uk-button-default uk-border-rounded uk-align-center" >Выбрать сейчас</a>
                                     </div>
                                 </div>

                                 <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 margin-top-10" >
                                   <div class="package">
                                     <p class="minimum">Минимальное финансирование<span class="price"> 1000 USD</span></p>
                                     <h2 class="title">счет для скальпинга</h2>
                                     <p class="desc">Получайте еще более узкие спреды и комиссии</p>
                                     <hr>
                                     <ul class="package-features-list package-features-list2">
                                     <li><i class="fa fa-check" aria-hidden="true"></i>1.7 от спреда</li>
                                     <li><i class="fa fa-check" aria-hidden="true"></i>1:100 Кредитное плечо</li>
                                     <li><i class="fa fa-check" aria-hidden="true"></i>1000$ Минимальное финансирование</li>
                                     <li><i class="fa fa-check" aria-hidden="true"></i>USD - основная валюта</li>
                                     <li><i class="fa fa-check" aria-hidden="true"></i>Исламский счет доступен</li>
                                     <li><i class="fa fa-check" aria-hidden="true"></i>Минимальный лот 0,01</li>
                                     <li><i class="fa fa-check" aria-hidden="true"></i>Советник</li>
                                     ...
                                     <li ><i class="fa fa-check" aria-hidden="true"></i>Скальпинг доступен</li>
                                     </ul>
                                       <a val="5" class="btn btn-success uk-button uk-button-default uk-border-rounded uk-align-center">Выбрать сейчас</a>
                                   </div>
                                 </div>
                                 ...
                                 <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 margin-top-10" >
                                   <div class="package">
                                     <p class="minimum">Минимальное финансирование<span class="price"> 100 USD</span></p>
                                     <h2 class="title">  бонусный счет</h2>
                                     <p class="desc">Получайте еще более узкие спреды и комиссии</p>
                                     <hr>
                                     <ul class="package-features-list package-features-list2">
                                     <li><i class="fa fa-check" aria-hidden="true"></i>2 фиксированный спред</li>
                                     <li><i class="fa fa-check" aria-hidden="true"></i>1:500 Кредитное плечо</li>
                                     <li><i class="fa fa-check" aria-hidden="true"></i>100$ Минимальное финансирование</li>
                                     <li><i class="fa fa-check" aria-hidden="true"></i>USD - основная валюта</li>
                                     <li><i class="fa fa-check" aria-hidden="true"></i>Исламский счет доступен</li>
                                     ...
                                     <li class="false"><i class="fa fa-times" aria-hidden="true"></i>Скальпинг недоступен</li>
                                       ...
                                       <a val="4" class=" btn btn-success uk-button uk-button-default uk-border-rounded uk-align-center">Выбрать сейчас</a>
                                   </div>
                                 </div>
 ...
 <!------------------------------------------End Table----------------------------------------->
            ...
            <div class="col-sm-12">
              ...
              <div class="row">
                ...
                <div class="col-sm-8" id="account_type" style-="display:none;">
                    ...
                    <div class="col-sm-8">
                        <div class="controls">
                            <select class="form-control" name="account_group" id="account_group"  onchange="accountGroup()"  required >
                                <option value="" disabled selected >- Выбрать -</option>
                                <option value="1" class="forlive" style-="display:none;">Счет с фиксированным спредом</option>
                                <option value="3" class="forlive" style-="display:none;">счет с переменным спредом</option>
                                <option value="5" class="forlive" style-="display:none;">счет для скальпинга</option>
                    ...
                    <div class="col-sm-8" >
                      <div class="col-sm-8  ">
                          <div class="controls" style-=" text-align: center; ">
                               <label style="margin:5px 0px;"> <input type="checkbox" value="0" required/> Я согласен условия и положения</label>
