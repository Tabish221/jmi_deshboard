 ...
 <div class="container">
        ...
        <p class="text-center error" style="display:none;"></p>
                          ...
                          @endif
	                             ...
	                             <form id="RegisterForm" role="form" action="{{ URL::to('/ru/signup') }}" method="post" class="registration-form">
                               ...
                               <div class="control-group">
                                  ...
                                  <div class="col-sm-8">
                                          <input type="email" name="email" placeholder="Эл. адрес :"    class="form-email form-control" id="email" required>
                                      </div>
                                      <div class="col-sm-4">
                                          <button type="button"  id="email_send_code"  class="btn btn-success" onclick="emailSendAuth();">Отправить код</button>
                                      </div>
                                  </div>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-8">
                                          <input type="number" id="emailverificationCode" name="emailverificationCode" class="form-control" placeholder="введите код подтверждения" style="display:none;" required>
                                      </div>
                                      <div class="col-sm-4" >
                                          <button type="button" id="email_verify_code" class="btn btn-success" onclick="emailcodeverify();"  style="display:none;">Проверить код</button>
                                      </div>
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="username" placeholder="имя пользователя :"    class="form-email form-control" id="username" required>
                                    </div>
                                  ...
                                  <div class="alert alert-success col-sm-12" id="sentSuccess" style="display: none;"></div>
                                      ...
                                      <div class="col-sm-5">
                                          <input type="number" id="number" class="form-control" name="phone_number" required>
                                      </div>

                                      <div class="col-sm-4">
                                          <button type="button"  id="send_code" class="btn btn-success" onclick="phoneSendAuth();">Отправить код</button>
                                      </div>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-4">
                                          <button type="button" id="verify_code" class="btn btn-success" onclick="codeverify();"  style="display:none;">Проверить код</button>
                                      </div>
                                  ...
                                  <script type="text/javascript">
                                      ...
                                      function phoneSendAuth() {
                                        ...
                                        var number = '+'+$("#countryCode").val()+$("#number").val();
                                          ...
                                          firebase.auth().signInWithPhoneNumber(number,window.recaptchaVerifier).then(function (confirmationResult) {
                                              ...
                                              $("#sentSuccess").text("Сообщение успешно отправлено.");
                                              $("#sentSuccess").show();
                                      ...
                                      function codeverify() {
                                          ...
                                          coderesult.confirm(code).then(function (result) {
                                              ...
                                              $("#successRegsiter").text("Код проверен, вы можете зарегистрироваться сейчас.");
                 ...
                 <div class="control-group">
                   ...
                   <div class="col-sm-6 padding-right-0 ">
                    ...
                    <p>Пожалуйста: ответьте на этот вопрос!</p>
                    {!!getCaptchaBox()!!}
                    </div>
                    <script>
                    ...
                    <button type="submit" class="btn btn-success submit" id="register"  >Зарегистрируйтесь сейчас</button>
               </form>
