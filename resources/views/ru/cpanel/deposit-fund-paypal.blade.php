...
@section('content')
    ...
    {!! Form::open(['url'=>'ru/cpanel/deposit-fund/paypal'])  !!}
...
@if(count($accounts)>0)
            ...
            <div class="col-sm-5 col-sm-push-1" >
                ...
                <div id="demoaccount">
                <img loading="lazy" src="/assets/cpanel/img/paypal.png" alt="PayPal"  class="max-width-100" />
                    <h3>PayPal Детали финансирования</h3>
