...
@section('content')
    ...
    {!! Form::open(['url'=>'ru/cpanel/deposit-fund/advcash'])  !!}
...
@if(count($accounts)>0)
            ...
            <div class="col-sm-5 col-sm-push-1" >
                ...
                <div id="demoaccount">
                <img loading="lazy" src="/assets/cpanel/img/advcash.png" alt="BitPay"  class="max-width-100" />
                    <h3>advcash Детали финансирования</h3>

                    <p>Экспресс депозит (1-2 рабочих дня)</p>
