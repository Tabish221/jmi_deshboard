...
@section('content')
   ...
   <div class="col-lg-9 col-lg-pull-3 col-md-12 col-sm-12 mainContent">
    ...
    {!! Form::open(['url'=>'ar/cpanel/withdraw-fund/pronto'])  !!}
...
@if(count($accounts)>0)
            ...
            <div class="col-sm-5 col-sm-pull-6" >
                ...
                <div id="demoaccount">
                <img loading="lazy" src="/assets/cpanel/img/pronto-logo.jpg" alt="Neteller"  class="max-width-100" />
                    <h3>تفاصيل السحب من خلال برونتو</h3>
