...
@section('content')
    ...
    {!! Form::open(['url'=>'ar/cpanel/deposit-fund/bankwire','files'=>true])  !!}
...
@if(count($accounts)>0)
            ...
            <div class="col-sm-6 col-sm-push-6">
                ...
                <br />
                <div class="row" id="amount">
                    <label class="col-sm-4 col-sm-push-8">رفع صورة الفاتورة:</label>
                    <div class="col-sm-8 col-sm-pull-4">
                        <div class="controls">
                ...
                <div class="row text-danger">
                    <p>فى حالة ان عملة حسابك متغيرة عن عملة الايداع سيتم خصم نسبة التحويل تبعا للبنك الخاص بك</p>
                </div>
            ...
            <div class="col-sm-5 col-sm-pull-6"  style="display:none;">

                <div id="demoaccount">
                <img loading="lazy" src="/assets/cpanel/img/bankwire.png" alt="Bank Wire"  class="max-width-100" />
                    <h3>تفاصيل الايداع البنكى</h3>

                    <a class="btn btn-default" data-toggle="modal" data-target="#deposit-bankwire">عرض التفاصيل</a>
                </div>
                  ...
                  <div class="modal-dialog  text-left" style="max-width: 880px;width:100%;">
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-footer">
                        ...
                        <a href="/ar/cpanel/deposit-fund/bankwire" class="btn btn-default" >أكمل الدفع</a>
                      </div>
                    </div>
