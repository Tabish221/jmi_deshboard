...
@section('content')
   ...
   <div class="col-lg-9 col-lg-pull-3 col-md-12 col-sm-12 mainContent">
    ...
    {!! Form::open(['url'=>'ar/cpanel/withdraw-fund/coinbase'])  !!}
...
@if(count($accounts)>0)
            ...
            <div class="col-sm-6 col-sm-push-6">
                ...
                <div class="row" id="coinbase_account">          
                    <label class="col-sm-4 col-sm-push-8"> حساب كوين بيز</label>         
                    <div class="col-sm-8 col-sm-pull-4">
                        <div class="controls">
            ...
            <div class="col-sm-5 col-sm-pull-6" >
                ...
                <div id="demoaccount">
                <img loading="lazy" src="/assets/cpanel/img/coinbase.png" alt="Neteller"  class="max-width-100" />
                    <h3>تفاصيل السحب من خلال كوين بيز</h3>
