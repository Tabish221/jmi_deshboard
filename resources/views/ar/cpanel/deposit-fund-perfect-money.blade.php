...
@section('content')
   ...
   <div class="col-lg-9 col-lg-pull-3 col-md-12 col-sm-12 mainContent">
    ...
    {!! Form::open(['url'=>'ar/cpanel/deposit-fund/perfect-money'])  !!}
...
@if(count($accounts)>0)
            ...
            <div class="col-sm-5 col-sm-pull-6 " >
                ...
                <div id="demoaccount">
                <img loading="lazy" src="/assets/cpanel/img/perfect-money.png" alt="neteller"  class="max-width-100" />
                    <h3>تفاصيل الايداع من بيرفكت مونى</h3>
