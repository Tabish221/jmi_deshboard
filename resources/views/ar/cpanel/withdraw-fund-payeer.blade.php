...
@section('content')
   ...
   <div class="col-lg-9 col-lg-pull-3 col-md-12 col-sm-12 mainContent">
    ...
    {!! Form::open(['url'=>'ar/cpanel/withdraw-fund/payeer'])  !!}
...
@if(count($accounts)>0)
            ...
            <div class="col-sm-6 col-sm-push-6">
                ...
                <br />
                <div class="row" id="payeer_account">          
                    <label class="col-sm-4 col-sm-push-8"> حساب Payeer</label>         
                    <div class="col-sm-8 col-sm-pull-4">
                        <div class="controls">
                            <input type="text" class="form-control" name="payeer_account" id="payeer_account" required />
            ...
            <div class="col-sm-5 col-sm-pull-6" >
                ...
                <img loading="lazy" src="/assets/cpanel/img/payeer.png" alt="Payeer"  class="max-width-100" />
                    <h3>تفاصيل السحب من خلال Payeer</h3>
