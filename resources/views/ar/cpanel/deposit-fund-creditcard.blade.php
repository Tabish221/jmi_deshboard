...
@section('content')
    ...
    {!! Form::open(['url'=>'ar/cpanel/deposit-fund/credit-card','id'=>'payingform'])  !!}
...
@if(count($accounts)>0)
            ...
            <div class="col-sm-6 col-sm-push-6">
               ...
               <!-- <input type='hidden' name='v_merchant_id' value='3181-0065366' /> -->
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8  col-sm-pull-4">
                        <div class="controls">
                             <input class="btn btn-success form-control" id="deposit_now" type="submit"  value="ايداع الان" disabled />
            ...
            <div class="col-sm-5 col-sm-pull-6" >
                ...
                <img loading="lazy" src="/assets/cpanel/img/creditcard.png" alt="Credit Card"  class="max-width-100" />
                    <h3>تفاصيل الايداع من خلال فيزا / بطاقة ائتمانية</h3>
