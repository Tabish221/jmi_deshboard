...
@section('content')
    ...
    {!! Form::open(['url'=>'ar/cpanel/deposit-fund/fasapay'])  !!}
...
@if(count($accounts)>0)
            ...
            <div class="col-sm-5 col-sm-pull-6 " >
                ...
                <div id="demoaccount">
                <img loading="lazy" src="/assets/cpanel/img/fasapay.png" alt="neteller"  class="max-width-100" />
                    <h3>تفاصيل الايداع من خلال FasaPay</h3>
