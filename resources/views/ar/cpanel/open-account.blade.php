...
@section('content')
<style>
   #agreement-row{direction: ltr;}
  #agreement-row *{font-weight: normal ;font-size: 14px;text-align:left;}
  ...
  li span , li span a{color: #4f81bd; font-weight: bold !important;}
  .footer
  {
    display: flex;
...
<style>
        ...
        #main-section-6 .package{height: 500px;padding: 30px 4px; margin:8px; background: #eeeeee;color:#0059b2;}
        ...
        #main-section-6 .package .price{margin-right: 10px;text-transform: uppercase; background: #0059b2; color: #ffc926; padding: 3px 10px; border-radius: 20px; margin-left: 10px;display: inline-block;}
        ...
        #main-section-6 .margin-top-10:hover .price{background: #ffc926; color: #0059b2;border-radius: 20px; }
        #main-section-6 .margin-top-10:hover .title{color: #ffc926;}
        #main-section-6 .margin-top-10:hover .uk-button{  background: #ffc926; color: #0059b2; border-radius: unset; }
        #main-section-6 .package .uk-button{position: absolute; right: 20px; bottom: 20px; left: 20px; border:none;cursor: pointer;padding: 14px 27px; display: flex; justify-content: center; font-size: 14px;}
...
@if($user->country =='' )
    <div class="alert alert-warning"  >
       لفتح حساب يجب عليك أكمال <a href="/ar/cpanel/profile">الملف الشخصى</a>
    </div>
...
@if(count($documents)< 1)
    <div class="alert alert-warning"  id="live-alert" style-="display: none;">
       لفتح حساب يجب ان يكون لديك 2 من  <a href="/ar/cpanel/documents"> المستندات</a> معتمدين
    </div>
...
@if (count($live_accounts)>9)
    <div class="alert alert-warning " id="live-alert" style="display: none;" >
       لقدد وصلت الى الحد الاقصى من عدد الحسابات المسموحة (10) من الحسابات الحقيقية
    </div>
@endif
...
<?PHP if($customer_agreement == null){ ?>
  {!! Form::open(['url'=>'ar/cpanel/post-agreement'])  !!}

  <div class="row" id="agreement-row" >


  <div style="height: 300px;overflow-y: scroll;margin: 10px 20px;padding: 10px;direction: ltr;">
    ...
    <p style="text-align:left;">
      ...
      <h5 class="bold left">JMI Brokers LTD is licensed broker from Vanuatu Financial Services Commission as Dealers in Securities under license number 15010</h5>
      <h5 class="bold left">Risk Disclosure Statement<h5>
      <p class="left">Before engaging in the products offered by JMI Brokers LTD</p>

      <p class="left">you should be aware of the risks which may be involved in such trading.</p>
      ...
      <p class="left">You have the responsibility to fully understand the terms and conditions of the transactions to be undertaken, including, without limitation:</p>
      <p class="left">1. The terms as to price, term, and expiration date, restrictions on exercising an OTC option and futures and of the terms material to the transaction.</p>
      <p class="left">2 . Any terms describing risk factors, such as volatility, liquidity, and so on.</p>
      <p class="left">3. The circumstances under which you may become obliged to make or take delivery of a Leveraged foreign exchange transaction or Futures contracts.</p>
      <p class="left">The high degree of leverage that is often obtainable in trading of the products offered by JMI Brokers LTD can work against you as well as for you, due to fluctuating market conditions. Trading in such instruments can lead to large losses as well as gains in response to a small market movement.
      <p class="left">If the market moves against you, you may not only sustain a total loss of your initial margin deposit, and any additional funds deposited with JMI Brokers LTD.</p>
      <p class="left">to maintain your position, but you may also incur further liability to JMI Brokers LTD. You may be called upon to “top-up” your margin by substantial amounts at short notice to maintain your position, failing which JMI Brokers LTD may have to liquidate your position at a loss and you would be liable for any resulting loss. You may sustain substantial losses on a contract or trade if the market conditions move against your position. It
      ...
      <p class="left">JMI Brokers LTD is authorized to purchase and sell Commodity Contracts for Customer’s account (i.e., all accounts opened on Customer’s behalf, accounts with Customer guarantees, and accounts for
      ...
      <p class="left">In the event that (a) Customer shall fail to timely deposit or maintain margin or any amount
      ...
      <p class="left">Until further notice in writing from the undersigned, JMI Brokers LTD is hereby authorized at anytime, without prior notice to the undersigned, to transfer from any account or accounts of the undersigned maintained at JMI Brokers LTD or any exchange member through which
      ...
      <p class="left">JMI Brokers LTD may execute Commodity Contracts for Customer’s account (s) either as principal or broker. As broker, JMI Brokers LTD will execute transaction similar to Customer’s transaction with another market participant in the financial market. As principal JMI Brokers LTD may not execute transaction similar to Customer in the financial market and hold the opposing transaction in JMI Brokers LTD inventory of Commodity Contracts. As a result of acting as principal Customer should realize that JMI Brokers LTD maybe acting as your counter party and that JMI Brokers LTD maybe placed in such a position that a conflict of duty
      ...
      <p class="left">This agreement shall be binding upon and inure to the benefit of JMI Brokers LTD ,its successors and assigns, and Customer’s heirs, executors, administrators, legatees, successors, personal representatives and assigns.
      ...
      <p class="left bold">We may, in our reasonable opinion, determine that an emergency or an exceptional market condition exists (a “Force Majeure Event”). A Force Majeure Event shall include, but is not limited to, the following:</p>
      ...
      <p class="left bold">If we determine that a Force Majeure Event exists we may in our absolute is creation without notice and at any time take one or more of the following steps:</p>
      ...
      <h5 class="bold left">23.	HEADINGS</h5>
      ...
      <h5 class="bold left">24.	GOVERNING LAW</h5>
      ...
      <h5 class="bold left">25.	ACCEPTANCE OF AGREEMENT</h5>
      ...
      <h5 class="bold left">26.	MULTIPLE ACCOUNTS</h5>
      ...
      <h5 class="bold left">27.	ASSIGNMENT</h5>
      ...
      <h5 class="bold left">28.	CUSTOMER ACKNOWLEDGMENTS AND SIGNATURE</h5>
      ...
      <p class="left">This agreement sets forth the terms and conditions under which we, JMI Brokers LTD ,shall permit you to have access to one or more terminals, including terminal access through your internet browser, for the electronic transmission of orders and \ or transactions, for your
      accounts with us. </p>
      <p class="left bold">This agreement also sets forth the terms and conditions under which we shall permit you electronically to monitor the activity, orders and\or transactions in your account (collectively, the “Online Service”). For purposes of this Agreement the term “Online Service” includes all software and communication links, and in consideration thereof, Customer agrees to the following:<p class="left">

      <h5 class="bold left">1.	LICENSE GRANT AND RIGHT OF USE</h5>
      <p class="left">By this Agreement, where we are supplying you with software for use with the Online Service,
    ...
    <div class="col-sm-8 col-sm-push-4" >
      <div class="row" >
        <label class="col-sm-4 col-sm-push-8">التوقيع</label>
        <div class="col-sm-8 col-sm-pull-4">
            <div class="controls">
                 <input class="form-control" type="text" name="signature" id="signature" placeholder="الأسم بالكامل  - التوقيع بالأنجليزية" required/>
                 <label style="margin:5px 0px;"> <input type="checkbox" value="0" required/> اوافق على جميع الشروط</label>
  ...
  <div class="row" >
    <div class="col-sm-8 col-sm-push-4" >
      <label class="col-sm-4 cols-sm-push-4"></label>
      <div class="col-sm-8 col-sm-pull-4">
          <div class="controls">
               <input class="btn btn-success form-control" type="submit" id="submit" value="فتح حساب"/>
...
<?PHP }else{ ?>
  ...
  {!! Form::open(['url'=>'ar/cpanel/open-account'])  !!}
                  ...
                  <div class="uk-grid uk-flex uk-flex-center">
                      ...
                      <div class="col-sm-12" id="main-pricing-list">
                          ...
                          <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 margin-top-10" >
                                      <div class="package">
                                        <p class="minimum">أقل ايداع<span class="price">100 USD </span></p>
                                        <h2 class="title">حساب اسبريد ثابت</h2>
                                        <p class="desc">احصل على فروق أسعار قليلة</p>
                                        <hr>
                                        <ul class="package-features-list package-features-list2">
                                            <li><i class="fa fa-check" aria-hidden="true"></i>اسبريد ثابت 1 نقطة فقط</li>
                                            <li><i class="fa fa-check" aria-hidden="true"></i>رافعة مالية تصل الى 1:500</li>
                                            <li><i class="fa fa-check" aria-hidden="true"></i>أقل ايداع 100$</li>
                                            <li><i class="fa fa-check" aria-hidden="true"></i>عملة الحساب الدولار الامريكى</li>
                                            <li><i class="fa fa-check" aria-hidden="true"></i>جميع الحسابات الأسلامية</li>
                                            <li><i class="fa fa-check" aria-hidden="true"></i>أقل لوت 0.01</li>
                                            <li><i class="fa fa-check" aria-hidden="true"></i>متاح الأكسبرت</li>
                                            <li><i class="fa fa-check" aria-hidden="true"></i>مسموح بالهيدج</li>
                                            <li><i class="fa fa-check" aria-hidden="true"></i>4 خانات</li>

                                            <li class="false"><i class="fa fa-times" aria-hidden="true"></i>غير مسموح بالأسكالبينج</li>
                                        </ul>
                                          <a val="1" class="btn btn-success uk-button uk-button-default uk-border-rounded uk-align-center">أختر الآن</a>
                                      </div>
                                  </div>

                                  <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 margin-top-10" >
                                      <div class="package">
                                        <p class="minimum">أقل ايداع<span class="price">500 USD </span></p>
                                        <h2 class="title">حساب اسبريد متغير</h2>
                                        <p class="desc">احصل على فروق أسعار قليلة</p>
                                        <hr>
                                        <ul class="package-features-list package-features-list2">

                                            <li><i class="fa fa-check" aria-hidden="true"></i> اسبريد يبدأ من 0.1</li>
                                            <li><i class="fa fa-check" aria-hidden="true"></i>رافعة مالية تصل الى 1:200</li>
                                            <li><i class="fa fa-check" aria-hidden="true"></i>أقل ايداع 500$</li>
                                            <li><i class="fa fa-check" aria-hidden="true"></i>عملة الحساب الدولار الأمريكى</li>
                                            <li><i class="fa fa-check" aria-hidden="true"></i>جميع الحسابات الأسلامية</li>
                                            <li><i class="fa fa-check" aria-hidden="true"></i>أقل لوت 0.01</li>
                                            <li><i class="fa fa-check" aria-hidden="true"></i>متاح الأكسبرت</li>
                                            <li><i class="fa fa-check" aria-hidden="true"></i>مسموح بالهيدج</li>
                                            <li><i class="fa fa-check" aria-hidden="true"></i>5 خانات</li>

                                            <li class="false"><i class="fa fa-times" aria-hidden="true"></i>غير مسموح بالأسكالبينج</li>
                                        </ul>
                                          <a val="3" class="btn btn-success uk-button uk-button-default uk-border-rounded uk-align-center" >أختر الآن</a>
                                      </div>
                                  </div>

                                  <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 margin-top-10" >
                                    <div class="package">
                                      <p class="minimum">أقل ايداع<span class="price"> 1000 USD</span></p>
                                      <h2 class="title">حساب سكالبينج</h2>
                                      <p class="desc">احصل على فروق أسعار قليلة</p>
                                      <hr>
                                      <ul class="package-features-list package-features-list2">

                                          <li><i class="fa fa-check" aria-hidden="true"></i>اسبريد يبدأ من 1.7</li>
                                          <li><i class="fa fa-check" aria-hidden="true"></i>رافعة مالية تصل الى 1:100</li>
                                          <li><i class="fa fa-check" aria-hidden="true"></i>أقل ايداع 1000$</li>
                                          <li><i class="fa fa-check" aria-hidden="true"></i>عملة الحساب الدولار الأمريكى</li>
                                          <li><i class="fa fa-check" aria-hidden="true"></i>جميع الحسابات الأسلامية</li>
                                          <li><i class="fa fa-check" aria-hidden="true"></i>أقل لوت 0.01</li>
                                          <li><i class="fa fa-check" aria-hidden="true"></i>متاح الأكسبرت</li>
                                          ...
                                          <li><i class="fa fa-check" aria-hidden="true"></i>مسموح بالاسكالبينج</li>

                                      </ul>
                                        <a val="5" class="btn btn-success uk-button uk-button-default uk-border-rounded uk-align-center">أختر الآن</a>
                                    </div>
                                  </div>
                                  ...
                                  <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 margin-top-10" >
                                    <div class="package">
                                      <p class="minimum">أقل ايداع<span class="price"> 100 USD</span></p>
                                      <h2 class="title">حساب بونص</h2>
                                      <p class="desc">احصل على فروق أسعار قليلة</p>
                                      <hr>
                                      <ul class="package-features-list package-features-list2">

                                          <li><i class="fa fa-check" aria-hidden="true"></i>اسبريد ثابت 2 نقطة فقط</li>
                                          <li><i class="fa fa-check" aria-hidden="true"></i>رافعة مالية تصل الى 1:500</li>
                                          <li><i class="fa fa-check" aria-hidden="true"></i>أقل ايداع 100$</li>
                                          <li><i class="fa fa-check" aria-hidden="true"></i>عملة الحساب الدولار الأمريكى</li>
                                          <li><i class="fa fa-check" aria-hidden="true"></i>جميع الحسابات الأسلامية</li>
                                        ...
                                        <a val="4" class=" btn btn-success uk-button uk-button-default uk-border-rounded uk-align-center">أختر الآن</a>
                                    </div>
                                  </div>
  ...
  <!------------------------------------------End Table----------------------------------------->
            ...
            <div class="col-sm-12">
                ...
                <div class="col-sm-8 col-sm-push-4" id="account_type" >
                    ...
                    <div class="col-sm-8 col-sm-pull-4">
                        <div class="controls">
                            <select class="form-control" name="account_group" id="account_group"  onchange="accountGroup()"  required >
                                ...
                                <option value="3" class="forlive" style-="display:none;">حساب اسبريد متغير</option>
                ...
                <div class="col-sm-8 col-sm-push-4">
                    ...
                    <div class="col-sm-8 col-sm-pull-4">
                        <div class="controls">
                            <select class="form-control" name="currency" id="currency" onchange="Currency(this.value);" required >
                                <option value="1" selected>دولار أمريكى</option>
                            </select>
                        </div>
                    </div>
                  </div>
...
<p  >* JMI Brokers LTD will not cover any profits or losses that may occur in any client account if market slip up or down more then 300 pips in 24 hours.</p>
<hr>
<h5 style="font-weight: bold; display: flex;align-items: center;margin:0px;float:left" class=""><img loading="lazy" style="margin-right: 5px;" src="/assets/m/img/arrow.png"> Contact us</h5>
<p class="bold blue" style="margin:0px 0px 20px 25px;clear:left;">JMI Brokers LTD</p>
<ul id="bottomUl">
                    ...
                    <div class="row" >
                      <div class="col-sm-8  ">
                          <div class="controls" style=" text-align: right; ">
                               <label style="margin:5px 35px"> <input type="checkbox" value="0" required/> اوافق على جميع الشروط واللوائح</label>
                    ...
                    <div class="col-sm-8 col-sm-pull-4">
                        <div class="controls">
                          <input type="number" class="form-control" name="account_radio_type" value="1" required style="display:none;"/>
                             ...
                             <input style="text-align:center" class="btn btn-success form-control" type="submit" id="submit" value="فتح حساب" />
                        </div>
                    </div>
                </div>
            {!! Form::close() !!}
