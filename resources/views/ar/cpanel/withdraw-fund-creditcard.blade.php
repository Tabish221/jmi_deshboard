...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery.maskedinput/1.4.1/jquery.maskedinput.js"></script>
    ...
    {!! Form::open(['url'=>'ar/cpanel/withdraw-fund/credit-card'])  !!}
...
@if(count($accounts)>0)
            ...
            <div class="col-sm-6 col-sm-push-6">
                ...
                <div class="row" id="credit_card">          
                    <label class="col-sm-4 col-sm-push-8">رقم فيزا / بطاقة ائتمانية:</label>         
                    <div class="col-sm-8 col-sm-pull-4">
                        <div class="controls">
                            <input type="tel" class="form-control" name="credit_card" OnFocus="Focus();" id="cc_number"  required />
                        </div>
                    </div>
                </div>
            ...
            <div class="col-sm-5 col-sm-pull-6" >
                ...
                <img loading="lazy" src="/assets/cpanel/img/creditcard.png" alt="Credit Card"  class="max-width-100" />
                    <h3>تفاصيل السحب من خلال فيزا / بطاقة ائتمانية</h3>

                    <p>سحب سريع يستغرق يوم او يومين عمل</p>
