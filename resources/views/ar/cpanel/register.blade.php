...
<style>
  ...
  input:-webkit-autofill,
      ...
      {
        div.col-sm-3.padding-right-0, div.col-sm-8 ,div.col-sm-6.padding-right-0,div.col-sm-9.padding-right-0
        {
			...
			<div class="myFlex">
				...
				<div class="col-lg-4 col-md-5 col-sm-6 col-xs-12 col-lg-push-8 col-md-push-6 col-sm-push-6  col-xxs text-right" >
                          ...
                          @endif
	                             ...
	                             <form id="RegisterForm" role="form" action="{{ URL::to('/ar/signup') }}" method="post" class="registration-form">
                                  ...
                                  <div class="col-sm-9 padding-right-0 ">
                                   <div class="controls">
                                        <input  type="text" class="form-control  " id="fullname" name="fullname" placeholder="الأسم بالكامل *" required>
                                   </div>
                                  </div>
                              </div>
                                ...
                                <div class="col-sm-8 col-sm-push-4">
                                        <input type="email" name="email" placeholder="البريد الالكترونى :"    class="form-email form-control" id="email" required>
                                    </div>
                                    <div class="col-sm-4 col-sm-pull-8" >
                                        <button type="button"  id="email_send_code"  class="btn btn-success" onclick="emailSendAuth();">ارسل الكود</button>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8 col-sm-push-4">
                                        <input type="number" id="emailverificationCode" name="emailverificationCode" class="form-control" placeholder="ادخل كود تفعيل البريد" style="display:none;" required>
                                    </div>
                                    <div class="col-sm-4 col-sm-pull-8" >
                                        <button type="button" id="email_verify_code" class="btn btn-success" onclick="emailcodeverify();"  style="display:none;">تفعيل الكود</button>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="username" placeholder="اسم المستخدم : بدون مسافات"    class="form-email form-control" id="username" required>
                                    </div>
                                      ...
                                      <div class="alert alert-success col-sm-12" id="sentSuccess" style="display: none;"></div>
                                          <div class="col-sm-4">
                                              <button type="button"  id="send_code"   class="btn btn-success" onclick="phoneSendAuth();">أرسل الكود</button>
                                          </div>
                                          <div class="col-sm-5">
                                              <input type="number" id="number" class="form-control" name="phone_number"  placeholder=" رقم التليفون المحمول  " required>
                                          </div>
                                          <div class="col-sm-3">
                                      ...
                                      <div class="form-group">
                                          <div class="col-sm-4">
                                              <button type="button" id="verify_code" class="btn btn-success" onclick="codeverify();"  style="display:none;">تأكيد الكود</button>
                                          </div>
                                          <div class="col-sm-8">
                                              <input type="number" id="verificationCode" class="form-control" placeholder="أدخل كود التأكيد"  style="display:none;" required>
                                          </div>
                                      ...
                                      <script type="text/javascript">
                                          ...
                                          function phoneSendAuth() {
                                            ...
                                            var number = '+'+$("#countryCode").val()+$("#number").val();
                                              ...
                                              firebase.auth().signInWithPhoneNumber(number,window.recaptchaVerifier).then(function (confirmationResult) {
                                                  ...
                                                  $("#sentSuccess").text("تم أرسال الكود بنجاح الى رقم الهاتف.");
                                                  $("#sentSuccess").show();
                                          ...
                                          function codeverify() {
                                              ...
                                              coderesult.confirm(code).then(function (result) {
                                                  ...
                                                  $("#successRegsiter").text("تم التفعيل, يمكنك التسجيل الأن.");
                 ...
                 <div class="control-group">
                   ...
                   <div class="col-sm-6 padding-right-0 ">
                    <div class="controls input-container">
                              <input  type="password" class="form-control  " placeholder=" تاكيد كلمة السر *" id="confirmpassword" name="confirmpassword" required>
                              ...
                              <button type="submit" class="btn btn-success submit"  id="register" >سجل الان</button>
                         </form>
