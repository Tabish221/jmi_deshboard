...
@section('content')
    ...
    {!! Form::open(['url'=>'ar/cpanel/deposit-fund/moneygram','files'=>true])  !!}
...
@if(count($accounts)>0)
            ...
            <div class="col-sm-5 col-sm-pull-6" >
                ...
                <div id="demoaccount">
                <img loading="lazy" src="/assets/cpanel/img/moneygram.png" alt="Bank Wire"  class="max-width-100" />
                    <h3>تفاصيل مونى جرام</h3>
