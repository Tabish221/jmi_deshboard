...
<div class="col-lg-9 col-lg-pull-3 col-md-12 col-sm-12 mainContent">
  ...
  <iframe scrolling="no" allowtransparency="true" frameborder="0" width="100%" height="500px" src="https://www.tradays.com/ar/economic-calendar/widget?mode=2&amp;utm_source=www.jmibrokers.com"></iframe>
      ...
      <div class="row" style="display:none;">
          ...
          <ul>
          <li><a class="btn last_week"  href="/ar/cpanel/calendar?date=last-week">الأسبوع الماضى</a></li>
          <li><a class="btn this_week"  href="/ar/cpanel/calendar?date=this-week">الأسبوع الحالى</a></li>
          <li><a class="btn next_week"   href="/ar/cpanel/calendar?date=next-week">الأسبوع القادم</a></li>
          <li><a class="btn yesterday"   href="/ar/cpanel/calendar?date=yesterday">الأمس</a></li>
          <li><a class="btn today"   href="/ar/cpanel/calendar?date=today">اليوم</a></li>
          <li><a class="btn tomorrow"   href="/ar/cpanel/calendar?date=tomorrow">غدا</a></li>
          </ul>
    ...
    <div class="row" style="display:none;">
          <h4>توقيت السرفر : <span id="calendar_time"></span></h4>
    </div>
