...
@if(count($accounts)>0)
    ...
    <div class="col-md-3 col-sm-4 col-xs-6  text-center"  style="display:none;">
			...
			<a href="/ar/cpanel/withdraw-fund/credit-card" class="btn btn-success form-control">سحب</a><br />
			<span class="cursor-pointer" data-toggle="modal" data-target="#withdraw-creditcard" style="display:none;">تفاصيل</span>
			<!-- Modal -->
			  ...
			  <div class="modal-dialog">
			    ...
			    <div class="modal-content text-left">
			      <div class="modal-header">
			        ...
			        <h4 class="modal-title">تفاصيل السحب من فيزا / بطاقة ائتمانية</h4>
			      </div>
		...
		<div class="col-md-3 col-sm-4 col-xs-6  text-center" style="display:none;">
			...
			<h3>نتلر</h3>
			<a href="/ar/cpanel/withdraw-fund/neteller" class="btn btn-success form-control">سحب</a><br />
			<span class="cursor-pointer" data-toggle="modal" data-target="#withdraw-neteller" style="display:none;">تفاصيل</span>
			<!-- Modal -->
			<div id="withdraw-neteller" class="modal fade" role="dialog">
			  <div class="modal-dialog  text-left">
			    ...
			    <div class="modal-content">
			      <div class="modal-header">
			        <button type="button" class="close" data-dismiss="modal">&times;</button>
			        <h4 class="modal-title">تفاصيل السحب من نتلر</h4>
			      </div>
			      <div class="modal-body">
    		...
    		<div class="col-md-3 col-sm-4 col-xs-6  text-center" style="display:none;">
    			...
    			<h3>اسكريل</h3>
    			<a href="/ar/cpanel/withdraw-fund/skrill" class="btn btn-success form-control">سحب</a><br />
    			<span class="cursor-pointer" data-toggle="modal" data-target="#withdraw-skrill" style="display:none;">تفاصيل</span>
    			<!-- Modal -->
    			<div id="withdraw-neteller" class="modal fade" role="dialog">
    			  <div class="modal-dialog  text-left">
		...
		<div class="col-md-3 col-sm-4 col-xs-6  text-center">
			...
			<h3>حوالة بنكية</h3>
			<a href="/ar/cpanel/withdraw-fund/bankwire" class="btn btn-success form-control">سحب</a><br />
			<span class="cursor-pointer" data-toggle="modal" data-target="#withdraw-bankwire" style="display:none;">تفاصيل</span>
			<!-- Modal -->
			<div id="withdraw-bankwire" class="modal fade" role="dialog">
			  <div class="modal-dialog  text-left">
			    ...
			    <div class="modal-content">
			      <div class="modal-header">
			        <button type="button" class="close" data-dismiss="modal">&times;</button>
			        <h4 class="modal-title">تفاصيل السحب من حوالة بنكية</h4>
			      </div>
			      <div class="modal-body">
			        <p>Bla Bla Bla</p>
			      </div>
		...
		<div class="col-md-3 col-sm-4 col-xs-6  text-center">
			<img loading="lazy" src="/assets/cpanel/img/epay.png" alt="Bank Wire"  class="max-width-100" />
			<h3>ايباى</h3>
			<a href="/ar/cpanel/withdraw-fund/epay" class="btn btn-success form-control">سحب</a><br />
			<span class="cursor-pointer" data-toggle="modal" data-target="#withdraw-epay" style="display:none;">تفاصيل</span>
			<!-- Modal -->
    ...
    <div class="col-md-3 col-sm-4 col-xs-6  text-center"  style="display:none;">
			...
			<h3>FasaPay</h3>
			<a href="/ar/cpanel/withdraw-fund/fasapay" class="btn btn-success form-control">سحب</a><br />
			<span class="cursor-pointer" data-toggle="modal" data-target="#withdraw-fasapay" style="display:none;">تفاصيل</span>
			<!-- Modal -->
    ...
    <div class="col-md-3 col-sm-4 col-xs-6  text-center"  style-="display:none;">
			...
			<h3>advcash</h3>
			<a href="/ar/cpanel/withdraw-fund/advcash" class="btn btn-success form-control">سحب</a><br />
			<span class="cursor-pointer" data-toggle="modal" data-target="#withdraw-advcash" style="display:none;">تفاصيل</span>
			<!-- Modal -->
    ...
    <div class="col-md-3 col-sm-4 col-xs-6  text-center"  style="display:none;">
			...
			<h3>Payeer</h3>
			<a href="/ar/cpanel/withdraw-fund/payeer" class="btn btn-success form-control">سحب</a><br />
			<span class="cursor-pointer" data-toggle="modal" data-target="#withdraw-payeer" style="display:none;">تفاصيل</span>
			<!-- Modal -->
    ...
    <div class="col-md-3 col-sm-4 col-xs-6  text-center"  style-="display:none;">
			...
			<h3>بيرفكت مونى</h3>
			<a href="/ar/cpanel/withdraw-fund/perfect-money" class="btn btn-success form-control">سحب</a><br />
			<span class="cursor-pointer" data-toggle="modal" data-target="#withdraw-perfect" style="display:none;">تفاصيل</span>
			<!-- Modal -->
    ...
    <div class="col-md-3 col-sm-4 col-xs-6  text-center"  style-="display:none;">
			...
			<h3>كوين بيز</h3>
			<a href="/ar/cpanel/withdraw-fund/coinbase" class="btn btn-success form-control">سحب</a><br />
			<span class="cursor-pointer" data-toggle="modal" data-target="#withdraw-coinbase" style="display:none;">تفاصيل</span>
			<!-- Modal -->
        ...
        <div class="col-md-3 col-sm-4 col-xs-6  text-center" >
          ...
          <h3>ويسترن يونيون</h3>
          <a href="#"  data-toggle="modal" data-target="#deposit-westernunion" class="btn btn-success form-control">سحب</a><br />
          ...
          <div id="deposit-westernunion" class="modal fade" role="dialog">
            <div class="modal-dialog  text-left">
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <p>لمزيد من التفاصيل أتصل بخدمة العملاء</p>
                </div>
                <div class="modal-footer">
                  <button type="button" class="btn btn-default" data-dismiss="modal">اغلق</button>
                </div>
            ...
            <div class="col-md-3 col-sm-4 col-xs-6  text-center" >
              ...
              <h3>مونى جرام</h3>
              <a href="#"  data-toggle="modal" data-target="#deposit-moneygram" class="btn btn-success form-control">سحب</a><br />
