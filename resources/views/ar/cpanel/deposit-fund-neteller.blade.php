...
@section('content')
   ...
   <div class="col-lg-9 col-lg-pull-3 col-md-12 col-sm-12 mainContent">
    ...
    {!! Form::open(['url'=>'ar/cpanel/deposit-fund/neteller'])  !!}
...
@if(count($accounts)>0)
            ...
            <div class="col-sm-6 col-sm-push-6">
                ...
                <div class="row" id="amount">
                    <label class="col-sm-4 col-sm-push-8">ايميل النتلر:</label>
                    <div class="col-sm-8 col-sm-pull-4">
                        <div class="controls">
                            <input type="email" class="form-control" name="netellermail" id="netellermail" required />
            ...
            <div class="col-sm-5 col-sm-pull-6 " >
                ...
                <img loading="lazy" src="/assets/cpanel/img/neteller.png" alt="neteller"  class="max-width-100" />
                    <h3>تفاصيل الايداع من خلال النتلر</h3>
