...
@if(count($accounts)<=0)
    <h4 class="col-sm-push-1"> ليس  لديك اى حسابات</h4>
@endif
@if(count($accounts)>0)
...
?>
    ...
    <h4 class="col-sm-push-1"> الحسابات التجريبية</h4>
        <hr />
        <div>
            ...
            <div id="searchdiv">
                <div class="col-sm-3 col-sm-push-9">
                    <select class="form-control" id="search"  name="search">
                        <option class="form-control" value="bynumber" >البحث برقم الحساب</option>
                    </select>
                </div>
                        ...
                        <tbody><?PHP $i=1;$n=0; ?>
                                @foreach($accounts as $account)
                                    ...
                                    <tr>
                                        ...
                                        <td>JMI-Demo</td>
                                        <td>@if($account->account_group ==1) حساب اسبريد متغير @endif @if($account->account_group ==2) حساب اسبريد ثابت @endif</td>
                                        <td>USD</td>
                                        ...
                                        <button class="btn btn-success" type="submit" >حذف الحساب</button>
                                        {!! Form::close() !!}
                                        @endif

                                        @if($account->status ==5)
                                        <button class="btn btn-success"  >جارى الحذف</button>
                                        @endif
