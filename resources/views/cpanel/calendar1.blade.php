...
@section('content')
  ...
  <iframe scrolling="no" allowtransparency="true" frameborder="0" width="100%" height="500px" src="https://www.tradays.com/en/economic-calendar/widget?mode=2&amp;utm_source=www.jmibrokers.com"></iframe>
      ...
      <div class="row" style="display:none;">
          ...
          <ul>
          <li><a class="btn last_week"  href="/en/cpanel/calendar?date=last-week">Last Week</a></li>
          <li><a class="btn this_week"  href="/en/cpanel/calendar?date=this-week">This Week</a></li>
          <li><a class="btn next_week"   href="/en/cpanel/calendar?date=next-week">Next Week</a></li>
          <li><a class="btn yesterday"   href="/en/cpanel/calendar?date=yesterday">Yesterday</a></li>
          <li><a class="btn today"   href="/en/cpanel/calendar?date=today">Today</a></li>
          <li><a class="btn tomorrow"   href="/en/cpanel/calendar?date=tomorrow">Tomorrow</a></li>
          </ul>
    ...
    <div class="row" style="display:none;">
          <h4>Server Time : <span id="calendar_time"></span></h4>
    </div>
