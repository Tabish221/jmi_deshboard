            ...
            <div class="theam-form mn-btn">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 pb-4">
                        ...
                        <select class="form-control1" name="title" id="title">
                    ...
                    <div class="col-md-8 pb-4">
                        ...
                        <input type="text" class="form-control1" id="fullname" name="fullname" value="{!! $user->fullname !!}">
                    </div>

                    <div class="col-md-6 pb-4">
                        <label for="form-email">Emaile</label>
                    ...
                    <div class="col-md-6 pb-4">
                        ...
                        <div class="d-flex flex-column gap-2">
                            <div class="">
                                <span id="changeemail" class="btn btn-warning px-4 py-3" onclick="changeemail();" ><i class="fa fa-edit"></i> Change Email</span>
                                <span id="checkemail" class="btn btn-primary px-4 py-3" onclick="checkemail();" style="display:none;"><i class="fa fa-sync"></i> Check Email </span>
                                <label for="email"></label>
                            </div>
                            <div class="sendverificationmailArea">
                                @if($user->email_status==0)
                                    <span class="text-danger">Unverified </span>
                                    (<span onclick="sendverificationmail();" id="sendverificationmail" style="cursor: pointer;">Send Verification Mail</span>)
                                @endif
                                @if($user->email_status==1)
                                    <span class="fa fa-check text-success">Verified</span>
                                @endif
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 pb-4">
                        ...
                        <input readonly  type="text" name="username" value="{!! $user->username !!}" class="form-control1" id="form-username"  required>
                    </div>
                    ...
                    <div class="col-md-6 pb-4">
                        ...
                        <div class="d-flex flex-column gap-2">
                            <div class="">
                                <span id="changeusername" class="btn btn-warning px-4 py-3" onclick="changeusername();" ><i class="fa fa-edit"></i> Change Username</span>
                                <span id="checkusername" class="btn btn-primary px-4 py-3" onclick="checkusername();" style="display:none;"><i class="fa fa-sync"></i> Check Username </span>
                    ...
                    <div class="col-md-4 pb-4">
                        <label for="form-email">Gender</label>
                    ...
                    <div class="col-md-8 pb-4">
                        <label for="form-email">Date Of Birth</label>
                    ...
                    <div class="col-md-5 pb-4">
                        ...
                        <a class="" href="/en/cpanel/password"  >Change Password</a>
                    </div>
                    ...
                    <div class="col-md-6 pb-4">
                        ...
                        <input type="text" name="address1" id="address1" value="{!! $user->address1 !!}"  class="form-control1"  required>
                    </div>

                    <div class="col-md-6 pb-4">
                        <label for="address2">Address 1</label>
                        <input type="text" name="address2" id="address2" value="{!! $user->address2 !!}"  class="form-control1"  >
                    </div>

                    <div class="col-md-4 pb-4">
                        <label for="townCity">Town/City</label>
                        <input type="text" name="town_city" id="townCity" value="{!! $user->town_city !!}"  class="form-control1"  required>
                    </div>

                    <div class="col-md-4 pb-4">
                        <label for="postCode">Post Code</label>
                        <input type="text" name="post_code" id="postCode" value="{!! $user->post_code !!}"  class="form-control1"  required>
                    </div>
                    ...
                    <div class="col-md-8 pb-4">
                        ...
                        <input type="text" name="home" id="homePhone" value="{!! $user->home !!}"  class="form-control1"  required>
                    </div>

                    <div class="col-md-4 pb-4">
                        <label for="mobileNumber">Home </label>
                        <select name="countryCode" id="countryCode2"  class="form-control"   required>
                            <option  value="" disabled selected>Code</option>
                            <option data-countryCode="DZ" value="213">+213</option>
                            <option data-countryCode="AD" value="376"> +376</option>
                            <option data-countryCode="AO" value="244"> +244</option>
                    ...
                    <div class="col-md-8 pb-4">
                        <label for="postCode">&nbsp;</label>
                        <input type="text" name="mobile" id="mobileNumber" value="{!! $user->mobile !!}"  class="form-control1"  >
                    ...
                    <div class="col-md-6 pb-4">
                        ...
                        <select class="form-control1" name="employment_status" id="employment_status" required >
                            <option value="" disabled selected >- Select -</option>
                    ...
                    <div class="col-md-6 pb-4">
                        ...
                        <select class="form-control1" name="nature_of_business" id="nature_of_business" required >
                            <option value="" disabled selected >- Select -</option>
                    ...
                    <div class="col-md-6 pb-4">
                        <label for="annual_income">Estimated Annual Income</label>
                        <select class="form-control1" name="annual_income" id="annual_income" required >
                            <option value="" disabled selected >- Select -</option>
                    ...
                    <div class="col-md-6 pb-4">
                        <label for="net_worth">Estimated Net Worth</label>
                    ...
                    <div class="col-md-4">
                        <div class="openAccount-formBtn mn-btn">
                            <button type="submit" class="lg w-100">Update Profile</button>
                        </div>
                    </div>
                </div>
                {!! Form::close() !!}
