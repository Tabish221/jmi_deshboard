...
@section('content')
    ...
    @if (count($accounts) > 0)
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="liveAccount-header mb-5">
                    <h6>Your account opening request is currently under review</h6>

                    <form class="theam-form">
                        <div class="row align-items-end">
                            <div class="col-md-4">
                                <label>Live Accounts</label>

                                <select id="search" name="search">
                                    <option value="0" selected disabled>- Setect -</option>
                                    <option class="form-control" value="bynumber">Account Number</option>
                                </select>
                            </div>

                            <div class="col-md-8">
                                <div class="transactionHistory-search tableSearch">
                    ...
                    <script>
                        bynumber = `<?php if (isset($_GET['bynumber'])) {
                            echo $_GET['bynumber'];
                        } ?>`;
                        selectby = `<?php if (isset($_GET['bynumber'])) {
                            echo 'bynumber';
                        } ?>`;
                ...
                <div class="liveAccount-body">
                    <div class="liveAccount-table">
                        <table class="table">
                            <thead>
                                <tr>
                                    <td>#</td>
                            ...
                            <tbody>
                                ...
                                @foreach ($accounts as $account)
                                    <tr>
                                        <td>{!! $i !!}</td>
                                        <td class="account_id_list" id="account_{!! $account->account_id !!}"><p class="acNo">{!! $account->account_id !!}</p></td>
                                        <td id="total_volume" style="display:none;" >0</td>
                                        <td>JMI Server</td>
                                        <td><p class="acType">@if ($account->account_type == 1) Individual Account @endif @if ($account->account_type == 2) IB Account @endif </p> </td>
                                        <td>
                                            @if ($account->account_group == 3)
                                                Variable Spread Account
                                            @endif
                                            @if ($account->account_group == 1)
                                                Fixed Spread Account
                                            @endif
                                            @if ($account->account_group == 4)
                                                Bonus Account
                                            @endif
                                            @if ($account->account_group == 5)
                                                Scalping Account
                                            @endif
                                        </td>
                                        <td class="acBlod">USD</td>
                                        <td class="acBlod">1:{!! $account->leverage !!}</td>
                                        <td><div class="acPassword"><button><i class="fas fa-eye"></i></button> <input type="password" disabled value="{!! $account->password !!}"></div> </td>
                                        <td><p class="acInvestor">{!! $account->investor_password !!}</p></td>
                                        <td class="acBlod">{!! $names[$n] !!}</td>
                                        <td class="acBalance">${!! $balances[$n] !!}
                                            @if ($balances[$n] !== '')
                                                <button class="btn btn-success" data-toggle="modal"
                                                    data-target="#history{!! $account->account_id !!}"
                                                    onclick="ResetHistory()">Show</button></a>
                                            @endif
                                        </td>
                                        <td >
                                            @if($balances[$n] !== '')
                                        ...
                                        <td class="acBalance">${!! $equities[$n] !!}</td>
                                        <td>
                                            <div class="acAction mn-btn">
                                                @if ($account->status == 0)
                                                    {!! Form::open([
                                                        'url' => 'en/cpanel/demo-accounts/' . $account->id,
                                                        'method' => 'delete',
                                                        'onsubmit' => 'return confirmDelete()',
                                                    ]) !!}
                                                        <button class="sm mb-1" type="submit">Delete Account</button>
                                                    {!! Form::close() !!}

                                                    <button class="sm mb-1" data-toggle="modal" data-target="#update{!! $account->id !!}" type="submit">Change Password</button>
                                                    <button class="sm mb-1" data-toggle="modal" data-target="#edit{!! $account->id !!}" type="submit">Edit Account</button>
                                                @endif

                                                @if ($account->status == 5)
                                                    <button class="sm mb-1" >Delete Pending</button>
                                                @endif
                                            </div>
                                        </td>
                                    </tr>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="controls">
                                    ...
                                    <input type="text" class="form-control " placeholder=" Old Real Password"
                                        value="{!! $account->password !!}" id="old_password" name="old_password" required>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="controls">
                                    ...
                                    <input type="text" class="form-control " placeholder=" New Real Password"
                                        value="{!! $account->password !!}" id="password" name="password" required>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12">
                                <div class="controls">
                                    ...
                                    <input type="text" class="form-control  " placeholder="New Investor Password"
                                        value="{!! $account->investor_password !!}" id="investor_password" name="investor_password"
                                        required>
                                    <br />
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="controls">
                                        ...
                                        <select class="form-control" name="account_type" id="account_type"
                                            onchange="LiveType(this.value)">
                                            <option value="1" @if ($account->account_type == 1) selected @endif>
                                                Individual</option>
                                            <option value="2" @if ($account->account_type == 2) selected @endif>IB
                                            </option>
                                ...
                                <div class="col-sm-12">
                                    <div class="controls">
                                        ...
                                        <select class="form-control" name="account_group" id="account_group"
                                            onchange="Group(this.value);" required>

                                            <option value="3" class="forlive"
                                                @if ($account->account_group == 3) selected @endif>Variable Spread Account
                                            </option>
                                            <option value="5" class="forlive"
                                                @if ($account->account_group == 5) selected @endif>Scalping Account</option>
                                            <option value="1" class="forlive"
                                                @if ($account->account_group == 1) selected @endif>Fixed Spread Account</option>
                                            <option value="4" class="forlive"
                                                @if ($account->account_group == 4) selected @endif> Bonus Account</option>
                                ...
                                <div class="col-sm-12">
                                    <div class="controls">
                                        ...
                                        <select class="form-control" name="leverage" id="leverage"
                                            onchange="Leverage(this.value);" required>
                                            <option value="1"@if ($account->leverage == 1) selected @endif>1:1
                                            </option>
                                            <option value="5"@if ($account->leverage == 5) selected @endif>1:5
                                            </option>
                                            <option value="10"@if ($account->leverage == 10) selected @endif>1:10
                                            </option>
                                            <option value="25"@if ($account->leverage == 25) selected @endif>1:25
                                            </option>
                                            <option value="50"@if ($account->leverage == 50) selected @endif>1:50
                                            </option>
                                            <option value="100"@if ($account->leverage == 100) selected @endif>1:100
                                            </option>
                                            <option value="200"@if ($account->leverage == 200) selected @endif>1:200
                                            </option>
                                            <option value="300" @if ($account->leverage == 300) selected @endif>1:300
                                            </option>
                                            <option value="400" @if ($account->leverage == 400) selected @endif>1:400
                                            </option>
                                            <option value="500" @if ($account->leverage == 500) selected @endif>1:500
                                            </option>
    ...
    @if(count($accounts)>0)
        ...
        @foreach($full_history_arr as $history2)
            <?PHP $history_arrays2 = array_values($history2); ?>
            ...
            <div id="history{!! $history2[0] !!}" class="modal fade history" role="dialog">
                <div class="modal-dialog" style="width: 80% !important">
                    <div class="modal-content">
                        ...
                        <div class="modal-body liveAccount-table">
                            <div >
                                <h3>Select Period</h3>

                                <div class="input-group input-daterange">
                                    <input id="startDate1-{!! $history2[0] !!}" name="startDate1-{!! $history2[0] !!}" type="text" class="form-control" readonly="readonly" style=" width: auto; float: none; ">
                                    <span>
                                        <span class="glyphicon glyphicon-calendar"></span>
                                    </span>
                                    <span class="">to</span>
                                    <input id="endDate1-{!! $history2[0] !!}" name="endDate1-{!! $history2[0] !!}" type="text" class="form-control" readonly="readonly" style=" width: auto; float: none; ">
                                    <span class="">
                                        <span class="glyphicon glyphicon-calendar"></span>
                                    </span>
                            ...
                            <table class="table" cellspacing="1" cellpadding="3" border="0" width="100%" style="font-size:12px;    margin: 10px 0px; font-family:Tahoma, Arial, Helvetica, sans-serif;">
                                <tr >
