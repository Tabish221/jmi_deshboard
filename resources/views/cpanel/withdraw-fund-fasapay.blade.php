...
@section('content')
    ...
    {!! Form::open(['url'=>'en/cpanel/withdraw-fund/fasapay'])  !!}
...
@if(count($accounts)>0)
            ...
            <div class="col-sm-6">
                ...
                <br />
                <div class="row" id="fasa_account">          
                    <label class="col-sm-4">FasaPay Account </label>         
                    <div class="col-sm-8">
                        <div class="controls">
                            <input type="text" class="form-control" name="fasa_account" id="fasa_account" required />
            ...
            <div class="col-sm-5 col-sm-push-1" >
                ...
                <img loading="lazy" src="/assets/cpanel/img/fasapay.png" alt="Fasapay"  class="max-width-100" />
                    <h3>Fasapay Withdrawing Details</h3>
