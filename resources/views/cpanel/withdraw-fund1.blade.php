...
@if(count($accounts)>0)
    ...
    <div class="col-md-3 col-sm-4 col-xs-6  text-center"  style="display:none;">
			...
			<h3>Credit Card</h3>
			<a href="/en/cpanel/withdraw-fund/credit-card" class="btn btn-success form-control">Withdraw</a><br />
			  ...
			  <div class="modal-dialog">
			    ...
			    <div class="modal-content text-left">
			      <div class="modal-header">
			        ...
			        <h4 class="modal-title">Credit Card Withdrawing Details</h4>
			      </div>
		...
		<div class="col-md-3 col-sm-4 col-xs-6  text-center" style="display:none;">
			...
			<h3>Neteller</h3>
			<a href="/en/cpanel/withdraw-fund/neteller" class="btn btn-success form-control">Withdraw</a><br />
			...
			<div id="withdraw-neteller" class="modal fade" role="dialog">
			  <div class="modal-dialog  text-left">
			    ...
			    <div class="modal-content">
			      <div class="modal-header">
			        <button type="button" class="close" data-dismiss="modal">&times;</button>
			        <h4 class="modal-title">Neteller Withdrawing Details</h4>
			      </div>
			      <div class="modal-body">
    ...
    <div class="col-md-3 col-sm-4 col-xs-6  text-center" style="display:none;">
      <img loading="lazy" src="/assets/cpanel/img/skrill.png" alt="Skrill"  class="max-width-100" />
      <h3>Skrill</h3>
      <a href="/en/cpanel/withdraw-fund/skrill" class="btn btn-success form-control">Withdraw</a><br />
      <span class="cursor-pointer" data-toggle="modal" data-target="#withdraw-skrill" style="display:none;">More Details</span>
      <!-- Modal -->
      <div id="withdraw-neteller" class="modal fade" role="dialog">
        <div class="modal-dialog  text-left">
          ...
          <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal">&times;</button>
              <h4 class="modal-title">Skrill Withdrawing Details</h4>
            </div>
            <div class="modal-body">
		...
		<div class="col-md-3 col-sm-4 col-xs-6  text-center">
			...
			<h3>Bank Wire</h3>
			<a href="/en/cpanel/withdraw-fund/bankwire" class="btn btn-success form-control">Withdraw</a><br />
			...
			<div id="withdraw-bankwire" class="modal fade" role="dialog">
			  <div class="modal-dialog  text-left">
			    ...
			    <div class="modal-content">
			      <div class="modal-header">
			        <button type="button" class="close" data-dismiss="modal">&times;</button>
			        <h4 class="modal-title">Bank Wire Withdrawing Details</h4>
			      </div>
			      <div class="modal-body">
			        <p>Bla Bla Bla</p>
			      </div>
    ...
    <div class="col-md-3 col-sm-4 col-xs-6  text-center"  style="display:none;">
			...
			<h3>Fasapay</h3>
			<a href="/en/cpanel/withdraw-fund/fasapay" class="btn btn-success form-control">Withdraw</a><br />
			...
			<div id="withdraw-fasapay" class="modal fade" role="dialog">
			  <div class="modal-dialog  text-left">
			    ...
			    <div class="modal-content">
			      <div class="modal-header">
			        <button type="button" class="close" data-dismiss="modal">&times;</button>
			        <h4 class="modal-title">Fasapay Withdrawing Details</h4>
			      </div>
			      <div class="modal-body">
			        <p>Bla Bla Bla</p>
			      </div>
		...
		<div class="col-md-3 col-sm-4 col-xs-6  text-center"  >
			...
			<h3>Epay</h3>
			<a href="/en/cpanel/withdraw-fund/epay" class="btn btn-success form-control">Withdraw</a><br />
			...
			<div id="withdraw-epay" class="modal fade" role="dialog">
			  <div class="modal-dialog  text-left">
			    ...
			    <div class="modal-content">
			      <div class="modal-header">
			        <button type="button" class="close" data-dismiss="modal">&times;</button>
			        <h4 class="modal-title">Epay Withdrawing Details</h4>
			      </div>
			      <div class="modal-body">
			        <p>Bla Bla Bla</p>
			      </div>
    ...
    <div class="col-md-3 col-sm-4 col-xs-6  text-center"  style="display:none;">
			...
			<h3>Payeer</h3>
			<a href="/en/cpanel/withdraw-fund/payeer" class="btn btn-success form-control">Withdraw</a><br />
    ...
    <div class="col-md-3 col-sm-4 col-xs-6  text-center"  style-="display:none;">
			...
			<h3>Perfect Money</h3>
			<a href="/en/cpanel/withdraw-fund/perfect-money" class="btn btn-success form-control">Withdraw</a><br />
		...
		<div class="col-md-3 col-sm-4 col-xs-6  text-center"  style-="display:none;">
			...
			<h3>advcash</h3>
			<a href="/en/cpanel/withdraw-fund/advcash" class="btn btn-success form-control">Withdraw</a><br />
    ...
    <div class="col-md-3 col-sm-4 col-xs-6  text-center"  style-="display:none;">
			...
			<h3>CoinBase</h3>
			<a href="/en/cpanel/withdraw-fund/coinbase" class="btn btn-success form-control">Withdraw</a><br />
    ...
    <div class="col-md-3 col-sm-4 col-xs-6  text-center" >
      ...
      <h3>Western Union</h3>
      <a href="#"  data-toggle="modal" data-target="#deposit-westernunion" class="btn btn-success form-control">Withdraw</a><br />
      ...
      <div id="deposit-westernunion" class="modal fade" role="dialog">
        ...
        <div class="col-md-3 col-sm-4 col-xs-6  text-center" >
          ...
          <h3>MoneyGram</h3>
          <a href="#"  data-toggle="modal" data-target="#deposit-moneygram" class="btn btn-success form-control">Withdraw</a><br />
