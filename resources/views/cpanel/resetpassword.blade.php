                                        ...
                                        <h2 class="title">Client Area </h2>
                                            ...
                                            <p style="color:red;text-align:center;">{{$errors->first('confirmnewpassword')}}</p>
                                                 <form id="changepassword" autocomplete="off" method="post" action="{{ URL::to('/en/resetpassword') }}" class="form-horizontal">
                                                    ...
                                                    <input name="newpassword" type="password" id="newpassword" placeholder="New Password :" class="form-control" /><br />
                                                    <input name="confirmnewpassword" type="password" id="confirmnewpassword" placeholder="Confirm Password :" class="form-control" /><br />
                                                    
                                                    <input type="submit" name="changesubmit" value="Change Now"  id="changesubmit" class="btn btn-success submit" />
