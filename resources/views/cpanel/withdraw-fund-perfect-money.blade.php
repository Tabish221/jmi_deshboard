                        ...
                        <div class="card-body">
                            <div class="theam-form mn-btn">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 pb-4">
                                        <label for="perfect_account">Perfect Money Account</label>
                                    ...
                                    <div class="col-md-8 pt-4">
                                        <div class="internalTransferDetail-cont text-center">
                                            <img loading="lazy" src="/assets/cpanel/img/perfect.png" alt="Perfect Money" class="max-width-100 mb-3" />
                                            <h6>Perfect Money Withdrawing Details</h6>
