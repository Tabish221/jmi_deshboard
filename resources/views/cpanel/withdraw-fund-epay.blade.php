                        ...
                        <div class="card-body">
                            <div class="theam-form mn-btn">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 pb-4">
                                        <label for="epay_account">Epay Account:</label>
                                    ...
                                    <div class="col-md-8 pt-4">
                                        <div class="internalTransferDetail-cont text-center">
                                            <img loading="lazy" src="/assets/cpanel/img/epay.png" alt="Epay" class="max-width-100 mb-3" />
                                            <h6>Epay Withdrawing Details</h6>
