...
@section('content')
    ...
    {!! Form::open(['url'=>'en/cpanel/withdraw-fund/neteller'])  !!}
...
@if(count($accounts)>0)
            ...
            <div class="col-sm-6">
                ...
                <br />
                <div class="row" id="neteller_id">
                    <label class="col-sm-4">Neteller email</label>
                    <div class="col-sm-8">
                        <div class="controls">
                            <input type="email" class="form-control" name="neteller_email" id="neteller_email" required />
            ...
            <div class="col-sm-5 col-sm-push-1" >
                ...
                <img loading="lazy" src="/assets/cpanel/img/neteller.png" alt="Neteller"  class="max-width-100" />
                    <h3>Neteller Withdrawing Details</h3>
