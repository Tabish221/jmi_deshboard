...
@section('content')
    ...
    {!! Form::open(['url'=>'en/cpanel/withdraw-fund/pronto'])  !!}
...
@if(count($accounts)>0)
            ...
            <div class="col-sm-5 col-sm-push-1" >
                ...
                <div id="demoaccount">
                <img loading="lazy" src="/assets/cpanel/img/pronto-logo.jpg" alt="pronto"  class="max-width-100" />
                    <h3>Pronto Withdrawing Details</h3>
