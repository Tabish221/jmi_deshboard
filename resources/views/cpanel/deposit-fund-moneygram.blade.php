...
@section('content')
    ...
    {!! Form::open(['url'=>'en/cpanel/deposit-fund/moneygram','files'=>true])  !!}
...
@if(count($accounts)>0)
            ...
            <div class="col-sm-5 col-sm-push-1" >
                ...
                <div id="demoaccount">
                <img loading="lazy" src="/assets/cpanel/img/moneygram.png" alt="Western Union"  class="max-width-100" />
                    <h3>MoneyGram Funding Details</h3>
