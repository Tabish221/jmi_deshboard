                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8 text-center">
                                        <div class="internalTransferDetail-cont">
                                            ...
                                            <h6>Perfect Money Funding Details</h6>
                    ...
                    @if (count($accounts) > 0)
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="row" id="amount">
                                ...
                                <div class="col-sm-8">
                                    <div class="controls">
                                        <input type="text" class="form-control" name="perfect_account"
                                            id="perfect_account" required />
                        ...
                        <div class="col-sm-5 col-sm-push-1">
                            ...
                            <div id="demoaccount">
                                <img loading="lazy" src="/assets/cpanel/img/perfect.png" alt="Epay"
                                    class="max-width-100" />
