                        ...
                        <div class="card-body">
                            <div class="theam-form mn-btn">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 pb-4">
                                        <label for="advcash_account">advcash Account</label>
                                    ...
                                    <div class="col-md-8 pt-4">
                                        <div class="internalTransferDetail-cont text-center">
                                            <img loading="lazy" src="/assets/cpanel/img/advcash.png" alt="advcash" class="max-width-100 mb-3" />
                                            <h6>advcash Withdrawing Details</h6>
                    ...
                    @if (count($accounts) > 0)
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="row" id="advcash_account">
                                ...
                                <div class="col-sm-8">
                                    <div class="controls">
                                        <input type="text" class="form-control" name="advcash_account"
                                            id="advcash_account" required />
