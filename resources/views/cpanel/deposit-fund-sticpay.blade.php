...
@section('content')
    ...
    {!! Form::open(['url'=>'en/cpanel/deposit-fund/sticpay'])  !!}
...
@if(count($accounts)>0)
            ...
            <div class="col-sm-5 col-sm-push-1" >
                ...
                <div id="demoaccount">
                <img loading="lazy" src="/assets/cpanel/img/sticpay.png" alt="SticPay"  class="max-width-100" />
                    <h3>SticPay Funding Details</h3>
