...
@section('content')
    ...
    {!! Form::open(['url'=>'en/cpanel/deposit-fund/bankwire','files'=>true])  !!}
...
@if(count($accounts)>0)
            ...
            <div class="col-sm-6">
                ...
                <br />
                <div class="row" id="amount">
                    <label class="col-sm-4">Upload a TT Copy File:</label>
                    <div class="col-sm-8">
                        <div class="controls">
                ...
                <br />
                <div class="row" id="amount">
                    <label class="col-sm-4">Upload Invoice:</label>
                    <div class="col-sm-8">
                        <div class="controls">
            ...
            <div class="col-sm-5 col-sm-push-1" style="display:none;">
                ...
                <div id="demoaccount">
                  ...
                  <a class="btn btn-default" data-toggle="modal" data-target="#deposit-bankwire">Show Bank Payment Details</a>
                </div>
