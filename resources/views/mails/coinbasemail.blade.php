<html><head>
	...
	<body   style=" direction: ltr !important;  font-family: Roboto-Light  !important; overflow-x:hidden !important;
		...
		<div class="row"   style=" direction: ltr !important;  font-family: Roboto-Light  !important;  ">
         ...
         <tr>
             <td style="width: 20%; vertical-align: top">JMI Account Number</td>
               <td style="vertical-align: top">{{ $jmiaccountnumber }}</td>
         </tr>
         <tr>
             <td style="width: 20%; vertical-align: top">Deposit Amount</td>
               <td style="vertical-align: top">{{ $ammount }}</td>
         </tr>
         <tr>
             <td style="width: 20%; vertical-align: top">Checkout ID</td>
               <td style="vertical-align: top"><?PHP echo $transactionid ?></td>
         </tr>
        </table>
