	...
	<body   style=" direction: ltr !important;  font-family: Roboto-Light  !important; overflow-x:hidden !important;
		...
		<div class="row"   style=" direction: ltr !important;  font-family: Roboto-Light  !important;  ">
			...
			<div id="content" class="col-sm-12"   style=" direction: ltr !important;  font-family: Roboto-Light  !important; margin: 0px 50px 25px 50px !important; ">
				...
				<table width="600px;" align="center"><tbody><tr><td style="font-family: Helvetica; font-size: 12px;">
       <p align="left" class="article-title" style="font-size: 14px; line-height: 24px; font-weight: bold; margin-top: 0px; margin-bottom: 18px; font-family: "> Dear <?PHP $titlearr=["Mr", "Mrs","Miss"];echo  $titlearr[$title].' '.$fullname ?></p>
       <span style="color: #222222">Thank you for registering demo account with JMI Brokers LTD, where our customers are the main priority of everything we do. <br><br>

      <h4>MT4 Login : <?PHP echo $mt4login ?></h4>
      <h4>MT4 Password :  <?PHP echo $mt4password ?></h4>
      <h4>MT4 Investor Password :  <?PHP echo $mt4investor ?></h4>
      <h4>MT4 Server :  37.220.103.186:443 </h4>

      <div style="margin-top:10px;margin-bottom:10px !important;"><p style="text-align:center;"><a href="https://download.mql5.com/cdn/web/jmi.brokers.ltd/mt4/jmibrokers4setup.exe" style="background:#5cb85c;padding:10px 50px;color:#fff;border-radius:6px;font-size:16px;text-decoration: none;"  >Download Platform</a></p></div>

        <br><br>
       <ul style="margin-bottom: 0px">
          <li>MT4 Live Account</li>
          <li>Your account in (JMI Brokers LTD) which will give you free access to : </li>
       </ul>
       <table cellspacing="0" cellpadding="0" border="0" align="center" style="font-family: Helvetica; font-size: 12px; width: 430px; padding: 8px 15px">
      <tbody>
      <tr> <td style="width: 10px; vertical-align: top"><img src="{{ URL::to('/assets/img/red_arrow.png') }}" alt=""></td><td style="vertical-align: top">Market Research &amp; Analysis (delivered also to your inbox).</td></tr>
      <tr> <td style="width: 10px; vertical-align: top"><img src="{{ URL::to('/assets/img/red_arrow.png') }}" alt=""></td><td style="vertical-align: top">Real-time news.</td></tr>
      <tr> <td style="width: 10px; vertical-align: top"><img src="{{ URL::to('/assets/img/red_arrow.png') }}" alt=""></td><td style="vertical-align: top">Dynamic economic calendar.</td></tr>
      <tr> <td style="width: 10px; vertical-align: top"><img src="{{ URL::to('/assets/img/red_arrow.png') }}" alt=""></td><td style="vertical-align: top">Best-in-class customer service, including live chat, service and around-the-clock support.</td></tr>
      <tr> <td style="width: 10px; vertical-align: top"><img src="{{ URL::to('/assets/img/red_arrow.png') }}" alt=""></td><td style="vertical-align: top">One-hour response time for all customer enquiries.</td></tr>
      </tbody></table><br>
      JMI Brokers LTD offers best-in-class customer service with around-the-clock support for our clients. <p>Best regards,<br>The JMI Brokers LTD Customer Support Team</p> </span></td></tr>
