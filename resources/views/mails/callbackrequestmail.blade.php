<html><head>
	...
	<body   style=" direction: ltr !important;  font-family: Roboto-Light  !important; overflow-x:hidden !important;
		...
		<div class="row"   style=" direction: ltr !important;  font-family: Roboto-Light  !important;  ">
			...
			<div id="content" class="col-sm-12"   style=" direction: ltr !important;  font-family: Roboto-Light  !important; margin: 0px 50px 25px 50px !important; ">
				 ...
				 <table cellspacing="2" cellpadding="2" border="1"  style="font-family:Helvetica;background: #0059b2;margin:0 auto;color: #fff;font-weight: bold;font-size: 15px;">
  <tr>
   <td style="width: 20%; vertical-align: top">Full name</td>
     <td style="vertical-align: top"><?PHP $titlearr=["Mr", "Mrs","Miss"];echo  $titlearr[$title].' '.$fullname ?></td>
  </tr>
  <tr>
   <td style="width: 20%; vertical-align: top">Country</td>
  ...
  <tr>
   <td style="width: 20%; vertical-align: top">City</td>
     <td style="vertical-align: top"><?PHP echo $city ?></td>
  </tr>
  <tr>
   <td style="width: 20%; vertical-align: top">Mobile</td>
     <td style="vertical-align: top"><?PHP echo $code.' '.$phone ?></td>
  </tr>
  <tr>
  ...
  <tr>
   <td style="width: 20%; vertical-align: top">Department</td>
     <td style="vertical-align: top"><?PHP $departmentarr=["Sales", "Customer Service","Account Opening"];echo  $departmentarr[$department]; ?></td>
  </tr>
  <tr>
   <td style="width: 20%; vertical-align: top">Time To Call</td>
     <td style="vertical-align: top"><?PHP echo $timetocall ?></td>
  </tr>
