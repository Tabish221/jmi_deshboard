<html><head>
  ...
  <h3>Dear {{$fullname}}</h3><br />
    <p>
		...
		As a result, we have issued the attached invoice so it can assist you in your bank payments.
 </p><br />



  <div id="section3" style=" text-align: left; ">
<span>We will be waiting for you to send us your SWIFT copy and/or TT on finance@jmibrokers.com</span>
  </div>
<p>
	P.S: Kindly make sure that all bank details like the correspondent bank name, the account number, the swift, etc are added correctly.
</p>
