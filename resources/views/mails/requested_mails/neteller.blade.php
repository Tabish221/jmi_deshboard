...
<h3>Dear {{$fullname}}</h3><br />
			<p>This mail is sent by your request for neteller payment details</p><br />
 ...
 <table cellspacing="2" cellpadding="2" border="1"  style="font-family:Helvetica;background: #0059b2;margin:0 auto;color: #fff;font-size: 15px;">
      ...
      <tr>
          <td style="width: 50%; vertical-align: top">Neteller Email </td>
            <td style="vertical-align: top">bishoyshenouda2019@gmail.com </td>
      </tr>
