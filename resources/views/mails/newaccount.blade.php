	...
	<body   style=" direction: ltr !important;  font-family: Roboto-Light  !important; overflow-x:hidden !important;
		...
		<div class="row"   style=" direction: ltr !important;  font-family: Roboto-Light  !important;  ">
			...
			<div id="content" class="col-sm-12"   style=" direction: ltr !important;  font-family: Roboto-Light  !important; margin: 0px 50px 25px 50px !important; ">
				 ...
				 <span style="font-size:18px;color:#15429f;display: block;">Dear {{ $fullname }} </span><br>
      <span style="font-size:18px;color:#333;display: block;">Thank you for registering account with JMI Brokers, where our customers are the main priority of everything we do. </span><br>
      <span style="font-size:18px;color:#333;display: block;">Your account in (JMI Brokers) which will give you free access to : </span><br>
       <ul style="padding-left:20px;">
           <li >Market Research & Analysis (delivered also to your inbox).</li>
           <li >Real-time news.</li>
           <li >Dynamic economic calendar.</li>
           <li >Best-in-class customer service, including live chat, service and around-the-clock support.</li>
           <li >One-hour response time for all customer enquiries.</li>
       </ul>
