	...
	<body   style=" direction: ltr !important;  font-family: Roboto-Light  !important; overflow-x:hidden !important;
		...
		<div class="row"   style=" direction: ltr !important;  font-family: Roboto-Light  !important;  ">
			{{-- <div class="col-sm-12"   style=" direction: ltr !important;  font-family: Roboto-Light  !important;  ">
				<img id="logoPic" src="{{asset('/images/jmi-header.png')}}"   style=" direction: ltr !important;
				
				font-family: Roboto-Light  !important; width: 100% !important;
				margin: 10px !important; ">
			</div> --}}
			<div class="col-sm-12"   style=" direction: ltr !important;  font-family: Roboto-Light  !important;  ">
				<img id="phonePic" src="{{asset('/images/jmi-header.png')}}"   style=" direction: ltr !important; 
				 font-family: Roboto-Light  !important; width:100% !important;">
			</div>
...
We have received a request from your side to change your account's password. 
<br>
...
- Be different from your account name
<br>
To reset your password, click on the below link before it expires in one hour:
				  </p>

<a href="{{$resetlink}}"><h4 style="color:#0059b2;">Reset Password Link </h4></a>
	      {{-- <p style=" font-size: 16px; padding-top:10px;">
	        This Link Is Avalaible Just For 1 Hour.
	      </p> --}}
				...
				font-weight:bold !important;">Should you need any further help, do not hesitate to contact us on:</p>
		...
		<div id="footer" class="row"   style="  float: left !important; direction: ltr !important;  font-family: Roboto-Light  !important; background-color:#0059b2 !important;
