<html><head>
	...
	<table cellspacing="2" cellpadding="2" border="1"  style="font-family:Helvetica;background: #0059b2;margin:0 auto;color: #fff;font-weight: bold;font-size: 15px;">
        <tr>
               <td style="width: 20%; vertical-align: top">Account Type</td>
                 <td style="vertical-align: top"><?PHP if($accounttype == 0){echo 'Micro';}elseif($accounttype == 1){echo 'Classic';}elseif ($accounttype==2){echo 'Golden';}elseif ($accounttype==3){echo 'Demo';} ?></td>
           </tr>
           ...
           <tr>
               <td style="width: 20%; vertical-align: top">Mobile</td>
                 <td style="vertical-align: top"><?PHP echo $mobile ?></td>
           </tr>
           <tr>
