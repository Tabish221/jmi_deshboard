...
<body>
    ...
    <h4 style="color:#0059b2;">Your Transaction has been submitted successfully</h4>
            <p style=" font-size: 16px; padding-top:10px;">
                Dear user,
<br>
                We are very pleased that you have done a transaction with us. JMI Brokers wish you the best!
                <br>
                Your transaction metadata:
                <br>
                <hr>
                Amount: {{$price}}
                <br>
