            ...
            <div class="">
                ...
                <div class="row">          
                    <table class="table table-bordered">
                        <thead>
                            <tr><td colspan="7">
                                    {!! Form::open(['url'=>'en/spanel/all-search/','id'=>'DeleteSelected','method'=>'delete','onsubmit' => 'return confirmDelete()']) !!}
                            ...
                            <?PHP  $i=1; ?>
                                @foreach($all_search as $search)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        {!! Form::open(['url'=>'en/spanel/all-search/'.$search->id,'method'=>'delete','onsubmit' => 'return confirmDelete()']) !!}
...
$('tbody tr td input.checkbox').click(function(){
   ...
   $('#DeleteSelected').attr('action', '/en/spanel/all-search/'+Arr);
