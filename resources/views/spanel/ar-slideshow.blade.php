...
<div class="box box-primary" id="profile-page">
    <div class="box-header">
        <h3 class="box-title"><strong>Arabic Slider</strong></h3>
    </div>
      ...
      <div class="item">
        ...
        <br /><br />
                  ...
                  <div class="row" style="background:gray;padding-bottom:25px;">
                        ...
                        <div class="col-sm-2">
                            <label style="display:block;">a1 Right</label>
                            <input type="number" name="a1right1" placeholder="a1 Right"  class="form-control"  value="{{ $slide1['a1_right'] }}" />
                        </div>
                  ...
                  <div class="row" style="backgsround:red;padding-bottom:25px;">
                        ...
                        <div class="col-sm-2">
                            <label style="display:block;">t Right</label>
                            <input type="number" name="tright1" placeholder="t Right"  class="form-control"  value="{{ $slide1['t_right'] }}" />
                        </div>
                  ...
                  <div class="row" style="background:gray;padding-bottom:25px;">
                        ...
                        <div class="col-sm-2">
                            <label style="display:block;">d1 Right</label>
                            <input type="number" name="d1right1" placeholder="d1 Right"  class="form-control"  value="{{ $slide1['d1_right'] }}" />
                        </div>
                  ...
                  <div class="row" style="backgrosund:red;padding-bottom:25px;">
                        ...
                        <div class="col-sm-2">
                            <label style="display:block;">d2 Right</label>
                            <input type="number" name="d2right1" placeholder="d2 Right"  class="form-control"  value="{{ $slide1['d2_right'] }}" />
                        </div>
                  ...
                  <div class="row" style="background:gray;padding-bottom:25px;">
                        ...
                        <div class="col-sm-2">
                            <label style="display:block;">d3 Right</label>
                            <input type="number" name="d3right1" placeholder="d3 Right"  class="form-control"  value="{{ $slide1['d3_right'] }}" />
                        </div>
                  ...
                  <div class="row" style="backgrosund:red;padding-bottom:25px;">
                        ...
                        <div class="col-sm-2">
                            <label style="display:block;">d4 Right</label>
                            <input type="number" name="d4right1" placeholder="d4 Right"  class="form-control"  value="{{ $slide1['d4_right'] }}" />
                        </div>
                  ...
                  <div class="row" style="background:gray;padding-bottom:25px;">
                        ...
                        <div class="col-sm-2">
                            <label style="display:block;">d5 Right</label>
                            <input type="number" name="d5right1" placeholder="d5 Right"  class="form-control"  value="{{ $slide1['d5_right'] }}" />
                        </div>
                  ...
                  <div class="row" style="backgsround:gray;padding-bottom:25px;">
                        ...
                        <div class="col-sm-2">
                            <label style="display:block;">btn Right</label>
                            <input type="number" name="btnright1" placeholder="btn Right"  class="form-control"  value="{{ $slide1['btn_right'] }}" />
                        </div>
      ...
      <div class="item">
        ...
        <br /><br />
                  ...
                  <div class="row" style="background:gray;padding-bottom:25px;">
                        ...
                        <div class="col-sm-2">
                            <label style="display:block;">a1 Right</label>
                            <input type="number" name="a1right2" placeholder="a1 Right"  class="form-control"  value="{{ $slide2['a1_right'] }}" />
                        </div>
                  ...
                  <div class="row" style="backgsround:red;padding-bottom:25px;">
                        ...
                        <div class="col-sm-2">
                            <label style="display:block;">t Right</label>
                            <input type="number" name="tright2" placeholder="t Right"  class="form-control"  value="{{ $slide2['t_right'] }}" />
                        </div>
                  ...
                  <div class="row" style="background:gray;padding-bottom:25px;">
                        ...
                        <div class="col-sm-2">
                            <label style="display:block;">d1 Right</label>
                            <input type="number" name="d1right2" placeholder="d1 Right"  class="form-control"  value="{{ $slide2['d1_right'] }}" />
                        </div>
                  ...
                  <div class="row" style="backgrosund:red;padding-bottom:25px;">
                        ...
                        <div class="col-sm-2">
                            <label style="display:block;">d2 Right</label>
                            <input type="number" name="d2right2" placeholder="d2 Right"  class="form-control"  value="{{ $slide2['d2_right'] }}" />
                        </div>
                  ...
                  <div class="row" style="background:gray;padding-bottom:25px;">
                        ...
                        <div class="col-sm-2">
                            <label style="display:block;">d3 Right</label>
                            <input type="number" name="d3right2" placeholder="d3 Right"  class="form-control"  value="{{ $slide2['d3_right'] }}" />
                        </div>
                  ...
                  <div class="row" style="backgrosund:red;padding-bottom:25px;">
                        ...
                        <div class="col-sm-2">
                            <label style="display:block;">d4 Right</label>
                            <input type="number" name="d4right2" placeholder="d4 Right"  class="form-control"  value="{{ $slide2['d4_right'] }}" />
                        </div>
                  ...
                  <div class="row" style="background:gray;padding-bottom:25px;">
                        ...
                        <div class="col-sm-2">
                            <label style="display:block;">d5 Right</label>
                            <input type="number" name="d5right2" placeholder="d5 Right"  class="form-control"  value="{{ $slide2['d5_right'] }}" />
                        </div>
                  ...
                  <div class="row" style="backgrsound:gray;padding-bottom:25px;">
                        ...
                        <div class="col-sm-2">
                            <label style="display:block;">btn Right</label>
                            <input type="number" name="btnright2" placeholder="btn Right"  class="form-control"  value="{{ $slide2['btn_right'] }}" />
                        </div>
      ...
      <div class="item">
        ...
        <br /><br />
                  ...
                  <div class="row" style="background:gray;padding-bottom:25px;">
                        ...
                        <div class="col-sm-2">
                            <label style="display:block;">a1 Right</label>
                            <input type="number" name="a1right3" placeholder="a1 Right"  class="form-control"  value="{{ $slide3['a1_right'] }}" />
                        </div>
                  ...
                  <div class="row" style="backgsround:red;padding-bottom:25px;">
                        ...
                        <div class="col-sm-2">
                            <label style="display:block;">t Right</label>
                            <input type="number" name="tright3" placeholder="t Right"  class="form-control"  value="{{ $slide3['t_right'] }}" />
                        </div>
                  ...
                  <div class="row" style="background:gray;padding-bottom:25px;">
                        ...
                        <div class="col-sm-2">
                            <label style="display:block;">d1 Right</label>
                            <input type="number" name="d1right3" placeholder="d1 Right"  class="form-control"  value="{{ $slide3['d1_right'] }}" />
                        </div>
                  ...
                  <div class="row" style="backgrosund:red;padding-bottom:25px;">
                        ...
                        <div class="col-sm-2">
                            <label style="display:block;">d2 Right</label>
                            <input type="number" name="d2right3" placeholder="d2 Right"  class="form-control"  value="{{ $slide3['d2_right'] }}" />
                        </div>
                  ...
                  <div class="row" style="background:gray;padding-bottom:25px;">
                        ...
                        <div class="col-sm-2">
                            <label style="display:block;">d3 Right</label>
                            <input type="number" name="d3right3" placeholder="d3 Right"  class="form-control"  value="{{ $slide3['d3_right'] }}" />
                        </div>
                  ...
                  <div class="row" style="backgrosund:red;padding-bottom:25px;">
                        ...
                        <div class="col-sm-2">
                            <label style="display:block;">d4 Right</label>
                            <input type="number" name="d4right3" placeholder="d4 Right"  class="form-control"  value="{{ $slide3['d4_right'] }}" />
                        </div>
                  ...
                  <div class="row" style="background:gray;padding-bottom:25px;">
                        ...
                        <div class="col-sm-2">
                            <label style="display:block;">d5 Right</label>
                            <input type="number" name="d5right3" placeholder="d5 Right"  class="form-control"  value="{{ $slide3['d5_right'] }}" />
                        </div>
                  ...
                  <div class="row" style="backsground:gray;padding-bottom:25px;">
                        ...
                        <div class="col-sm-2">
                            <label style="display:block;">btn Right</label>
                            <input type="number" name="btnright3" placeholder="btn Right"  class="form-control"  value="{{ $slide3['btn_right'] }}" />
                        </div>
      ...
      <div class="item">
        ...
        <br /><br />
                  ...
                  <div class="row" style="background:gray;padding-bottom:25px;">
                        ...
                        <div class="col-sm-2">
                            <label style="display:block;">a1 Right</label>
                            <input type="number" name="a1right4" placeholder="a1 Right"  class="form-control"  value="{{ $slide4['a1_right'] }}" />
                        </div>
                  ...
                  <div class="row" style="backgsround:red;padding-bottom:25px;">
                        ...
                        <div class="col-sm-2">
                            <label style="display:block;">t Right</label>
                            <input type="number" name="tright4" placeholder="t Right"  class="form-control"  value="{{ $slide4['t_right'] }}" />
                        </div>
                  ...
                  <div class="row" style="background:gray;padding-bottom:25px;">
                        ...
                        <div class="col-sm-2">
                            <label style="display:block;">d1 Right</label>
                            <input type="number" name="d1right4" placeholder="d1 Right"  class="form-control"  value="{{ $slide4['d1_right'] }}" />
                        </div>
                  ...
                  <div class="row" style="backgrosund:red;padding-bottom:25px;">
                        ...
                        <div class="col-sm-2">
                            <label style="display:block;">d2 Right</label>
                            <input type="number" name="d2right4" placeholder="d2 Right"  class="form-control"  value="{{ $slide4['d2_right'] }}" />
                        </div>
                  ...
                  <div class="row" style="background:gray;padding-bottom:25px;">
                        ...
                        <div class="col-sm-2">
                            <label style="display:block;">d3 Right</label>
                            <input type="number" name="d3right4" placeholder="d3 Right"  class="form-control"  value="{{ $slide4['d3_right'] }}" />
                        </div>
                  ...
                  <div class="row" style="backgrosund:red;padding-bottom:25px;">
                        ...
                        <div class="col-sm-2">
                            <label style="display:block;">d4 Right</label>
                            <input type="number" name="d4right4" placeholder="d4 Right"  class="form-control"  value="{{ $slide4['d4_right'] }}" />
                        </div>
                  ...
                  <div class="row" style="background:gray;padding-bottom:25px;">
                        ...
                        <div class="col-sm-2">
                            <label style="display:block;">d5 Right</label>
                            <input type="number" name="d5right4" placeholder="d5 Right"  class="form-control"  value="{{ $slide4['d5_right'] }}" />
                        </div>
                  ...
                  <div class="row" style="backgsround:gray;padding-bottom:25px;">
                        ...
                        <div class="col-sm-2">
                            <label style="display:block;">btn Right</label>
                            <input type="number" name="btnright4" placeholder="btn Right"  class="form-control"  value="{{ $slide4['btn_right'] }}" />
                        </div>
      ...
      <div class="item">
        ...
        <br /><br />
                  ...
                  <div class="row" style="background:gray;padding-bottom:25px;">
                        ...
                        <div class="col-sm-2">
                            <label style="display:block;">a1 Right</label>
                            <input type="number" name="a1right5" placeholder="a1 Right"  class="form-control"  value="{{ $slide5['a1_right'] }}" />
                        </div>
                  ...
                  <div class="row" style="backgsround:red;padding-bottom:25px;">
                        ...
                        <div class="col-sm-2">
                            <label style="display:block;">t Right</label>
                            <input type="number" name="tright5" placeholder="t Right"  class="form-control"  value="{{ $slide5['t_right'] }}" />
                        </div>
                  ...
                  <div class="row" style="background:gray;padding-bottom:25px;">
                        ...
                        <div class="col-sm-2">
                            <label style="display:block;">d1 Right</label>
                            <input type="number" name="d1right5" placeholder="d1 Right"  class="form-control"  value="{{ $slide5['d1_right'] }}" />
                        </div>
                  ...
                  <div class="row" style="backgrosund:red;padding-bottom:25px;">
                        ...
                        <div class="col-sm-2">
                            <label style="display:block;">d2 Right</label>
                            <input type="number" name="d2right5" placeholder="d2 Right"  class="form-control"  value="{{ $slide5['d2_right'] }}" />
                        </div>
                  ...
                  <div class="row" style="background:gray;padding-bottom:25px;">
                        ...
                        <div class="col-sm-2">
                            <label style="display:block;">d3 Right</label>
                            <input type="number" name="d3right5" placeholder="d3 Right"  class="form-control"  value="{{ $slide5['d3_right'] }}" />
                        </div>
                  ...
                  <div class="row" style="backgrosund:red;padding-bottom:25px;">
                        ...
                        <div class="col-sm-2">
                            <label style="display:block;">d4 Right</label>
                            <input type="number" name="d4right5" placeholder="d4 Right"  class="form-control"  value="{{ $slide5['d4_right'] }}" />
                        </div>
                  ...
                  <div class="row" style="background:gray;padding-bottom:25px;">
                        ...
                        <div class="col-sm-2">
                            <label style="display:block;">d5 Right</label>
                            <input type="number" name="d5right5" placeholder="d5 Right"  class="form-control"  value="{{ $slide5['d5_right'] }}" />
                        </div>
                  ...
                  <div class="row" style="backgrosund:gray;padding-bottom:25px;">
                        ...
                        <div class="col-sm-2">
                            <label style="display:block;">btn Right</label>
                            <input type="number" name="btnright5" placeholder="btn Right"  class="form-control"  value="{{ $slide5['btn_right'] }}" />
                        </div>
