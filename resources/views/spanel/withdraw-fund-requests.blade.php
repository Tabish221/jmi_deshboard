...
<div class="box box-primary">
    <div class="box-header">
        <h3 class="box-title">Withdraw Funds <strong> Requests </strong> </h3>
    </div>
...
@endif
            ...
            <div class="">
                ...
                <a class="btn @if ( Request::segment(4) =='') btn-success @else btn-default @endif " href="/en/spanel/withdraw-fund-requests">All</a>
                <a class="btn @if ( Request::segment(4) =='pending') btn-success @else btn-default @endif "  href="/en/spanel/withdraw-fund-requests/pending">Pending</a>
                <a class="btn @if ( Request::segment(4) =='done') btn-success @else btn-default @endif "  href="/en/spanel/withdraw-fund-requests/done">Done</a>
                <a class="btn @if ( Request::segment(4) =='rejected') btn-success @else btn-default @endif "  href="/en/spanel/withdraw-fund-requests/rejected">Rejected</a>
                    ...
                    <tbody>
                        ...
                        @foreach($transactions as $transaction)
                                ...
                                <div id="mydone{!! $transaction->id !!}" class="modal fade" role="dialog">
                                        {!! Form::open(['url'=>'en/spanel/withdraw-fund-requests'])  !!}
