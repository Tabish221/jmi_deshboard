...
<html lang="en">
    ...
    <head>
        ...
        <meta property="og:image" content="https://www.jmibrokers.com/assets/landing/fb/oil-trading.jpg"/>
       ...
       <meta property="og:title" content="JMI Brokers | The Best Broker"/>
        ...
        <meta property="og:url" content="https://www.jmibrokers.com/en/landingpage15"/>
...
<style>
  ...
  src: url(/assets/landing/TOYOTAARABICDISPLAY-REGULAR.TTF);
    ...
    p, span{font-size:15px;margin:0px;}
     h5,a{font-size:20px;}
     h3{font-size: 32px;margin: 5px 0px;}
...
@media only screen and (max-width: 1300px) {
  ...
  div#text{background:rgba(33,33,33,0.5);}
}

@media only screen and (min-width: 1061px) {
  
  #footer div#left{float: right;width: 190px;}
  #footer div#right{float: right;}

}

@media only screen and (max-width: 768px) {
div.responsive-bg{background: #003548;}
}
@media only screen and (min-width: 769px) {
div#responsive-bg2{background: #003548;border:10px solid #fff;border-radius: 100px;padding-top: 20px;}
}
    ...
    <body>
        ...
        <?PHP
            if(empty(session('refeer_cookie'))){
                    session()->put('refeer_cookie', 'landing 15');
                }
        ?>
...
<div class="raw">
    ...
    <div class="raw" id="content">
        <div class="container">
            ...
            <div class="container " style="background:rgba(255,255,255,0.6);border-radius: 20px;padding-right: unset;">
                <div class="col-sm-3 col-sm-push-9" id="right" style="background:#fff;border-radius: 20px;padding: 0px;">
                    <p style="font-size: 32px !important;color:#333;margin:20px 10px;line-height: 42px;">يمكنك تحقيق الأرباح من العلامات التجارية الرائدة فى العالم </p>
                </div>
                ...
                <dir class="col-sm-9 col-sm-pull-3" id="left">
                    ...
                    <div class="col-sm-4">
                        <input type="email"   class="form-control" name="email" placeholder="البريد الالكترونى" style="height: 40px; border-radius: 20px; text-align: right; font-weight: bold;margin: 4px 0px; " >
                    </div>
                   
                    <div class="col-sm-4">
                        <input type="text"   class="form-control"  name="name" placeholder="الأسم " style="height: 40px; border-radius: 20px; text-align: right; font-weight: bold;margin: 4px 0px;" required>
                    </div>
         ...
         <div class="col-sm-4">
                        ...
                        <input type="number"   class="form-control"  name="phone" placeholder="رقم الهاتف" style="height: 40px; border-radius: 20px; text-align: right; font-weight: bold;margin: 4px 0px;" required>
                    </div>
                    ...
                    <div class="col-sm-4">
                        ...
                        <select name="countryCode" id="countryCode"  class="form-control" style="height: 40px; border-radius: 20px; text-align: right; font-weight: bold; margin: 4px 0px;"   required>
        ...
        <option data-countryCode="ZW" value="263"> +263</option>
                    ...
                    <div class="col-sm-4">
                                  ...
                                  <select name="country" id="country"  class="form-control" onchange="countryfun();" style="height: 40px; border-radius: 20px; text-align: right; font-weight: bold; margin: 4px 0px;" required>
                         ...
                         <input type="hidden" name="landing_name" value="landing15">
   ...
   <div class="container" id="footer" style="margin-top: 8px;">
       
       <div class="col-sm-12" id="responsive-bg2">
           


           <div class=" col-sm-4 col-xs-12 col-sm-push-8  responsive-bg">
               <div id="right" >
           ...
           <div class=" col-sm-4 col-xs-12 responsive-bg">
               <div id="right" >
            ...
            <div class=" col-sm-4 col-xs-12 col-sm-pull-8  responsive-bg">
               <div id="right" >
...
<div class="container" style="">
            <span class="li-social" style="background: rgba(255,255,255,0.3); padding: 10px; margin: 5px; font-size: 20px; display: inline-block;">
                Contact us
