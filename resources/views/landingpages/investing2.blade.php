	...
	<body>
        ...
        <?PHP
            if(empty(session('refeer_cookie'))){
              session()->put('refeer_cookie', 'Investing.Com');
                }
        ?>
				<!--
        ...
        <div id="bgContainer" class="row">
            <div id="form" class="col-sm-12 col-md-4">
                ...
                <form role="form" id="landing-form" action="{{ URL::to('/en/landingpage3') }}" method="post" >
                    ...
                    <div class="controls selCtl">
                        <input type="hidden" name="landing_name" value="Wikifx">
            ...
            <div id="textSide" class="col-sm-12 col-md-4">
                ...
                <h2 class="boldBlue"><img src ="/assets/m/img/arrow2.png">NO SWAP</h2>
								...
								<h2 class="boldBlue"><img src ="/assets/m/img/arrow2.png">ISLAMIC TRADING ACCOUNTS</h2>
                ...
                <div class="imgNtext">
				 ...
				 <h2 class="boldBlue bgOrange">Risk Warning</h2>
                <div class="imgNtext">
					<h5 style="color:#0057af;">High Risk Investment Warning:</h5>

                    <h5>Trading foreign exchang 
and/or contracts for differences on margin carries a high level of risk, and may not be suitable for all investors. <br> 
The possibility exists that you could sustain a loss in excess of your deposited funds and therefore, you should not speculate with capital that you cannot afford to lose.before decig to trade the products offered by JMI Brokers you should carefully consider your objectives, financial
situation, needs and level of experience. you should be aware of all the risks associated with tradingin. JMI Brokers providers general advice that does not take into account your
objectives, financial situation or needs. the content of this Website must not be construed as personal advice. JMI Brokers recommends you seek advice from a separate financial 
advisor. All opininos, news, analysis, prices or other information contined on this website as general market commentary and does not constitue investment advice, 
nor a solicitaion  or recommendation for you to buy or sell any over-the-country product or other financial instrument.</h5>
