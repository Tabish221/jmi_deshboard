    ...
    <body>
        ...
        <?PHP
            if(empty(session('refeer_cookie'))){
                    session()->put('refeer_cookie', 'landing 17');
                }
        ?>

<div class="raw" style="    background: linear-gradient(90deg, #1d374d 50%, #365aa9 50%);
    border-bottom: 5px solid #fff;">
        <div class="container">
            <div class="col-md-4 col-md-push-8">
        <div class="raw text-center" id="logo1" style="padding: 5px 15px 0px;">
            <a href="/"><img src="/assets/landing/landing-logo17.png" style="width: 250px;"></a>
        </div>
                    <span class="li-social" style=" margin: 5px; font-size: 20px; display: inline-block;">   
            ...
            <div class="col-md-3 col-md-push-1">
                <img src="/assets/landing/swiss-uk-flag.png">
                
            </div>
            <div class="col-md-5 col-md-pull-7">
                <div class="col-md-6  col-md-push-6 col-sm-12" style="min-height:125px;color: #fff;padding: 10px 0px;">
                        <h4 >نحن حاصلين على ترخيص</h4>
                        <h3>سويسرى</h3>
                        <h4 >هيئة الأوراق المالية</h4>
                        <h4>مسجل بمدينة زج</h4>
                </div>
                <div class="col-md-6  col-md-pull-6 col-sm-12" style="min-height:125px;color: #fff;padding: 10px 0px;">
                        <h4 >وحاصلين على تراخيص</h4>
                        <h3 >من أحدى دول الكومنولث البريطانية</h3>
                        <h4 > (VFSC - Vanuatu)  </h4>
                </div>
...
<div class="container" style="padding-top: 20px;">
        ...
        <div class="col-md-4">
            <img src="/assets/landing/landing17-girl.png" style="padding-top: 8px;">
        </div>
        <div class="col-md-4">
            <p style="color: #002d42; font-size: 50px; line-height: 50px; padding-top: 102px; font-weight: bold;">Trade <br /> Forex, Gold, Silver, Oil, US Shares and UK Shares</p>

        </div>

        <div class="col-md-4">

                        <div class="form-box" style="margin:0 auto;;background: #0095c7;">
                            <div class="form-top" style="    background: #002d42;">
                                <div class="form-top-left">
                                    <h4 style="font-weight:bold;">JMI Brokers</h4>
                                    <p style="font-size:18px;color: #0095c7;">سجل الأن</p>
                                </div>
                                <div class="form-top-right">
                                    <i class="fa fa-book" style="color: #00bfff;"></i>
                            ...
                            <div class="form-bottom" style="text-align:center;">
                             ...
                             <input type="hidden" name="landing_name" value="landing17">
...
<div class="col-sm-8"  id="phone" style="margin-bottom:15px;margin-right:0px;padding-right:0px;">
                                        ...
                                        <input type="number" name="phone" placeholder=" رقم الهاتف  :" class="form-last-name form-control" id="form-last-name" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label class="sr-only" for="form-email">البريد الألكترونى :</label>
                                        <input type="email" name="email" placeholder="البريد الألكترونى :" class="form-email form-control" id="form-email" >
                                    </div>
                                    <button type="submit"   class="btn" style="background: #002d42;">ابدأ الأن</button>
                                </form>
                            </div>
                        </div>
