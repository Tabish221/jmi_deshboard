...
google.maps.event.addDomListener(window, 'load', initialize);
    ...
    <?PHP
            if(empty(session('refeer_cookie'))){
                    session()->put('refeer_cookie', 'landing 1');
                }
        ?>

        <!-- Top menu -->
        <nav class="navbar navbar-inverse navbar-no-bg" role="navigation" style="border-color:none;">
            <div class="container">
            ...
            <div class="inner-bg">
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8">
                            <h1 style="background:#0053af;padding:5px;border-radius:10px;margin-bottom:0px;">تداول الفوركس , ذهب , بترول , أسهم بريطانية و أمريكية</h1>
        ...
        <img src="{{ URL::asset('assets/landing/landingtrend2.png') }}" alt="" class="" />
                        ...
                        <div class="col-sm-4 form-box" style="margin:0 auto;">
                            <div class="form-top">
                                <div class="form-top-left">
                                    ...
                                    <p style="font-size:18px;">أنتهز الفرصة وسجل الأن</p>
                                </div>
                            ...
                            <div class="form-bottom" style="text-align:center;">
                                <form role="form" action="{{ URL::to('/en/landingpage1') }}" id="landing-form" method="post" class="registration-form">
                                    <div class="form-group">
                                        <label class="sr-only" for="form-first-name"> الأسم الأول :</label>
                                        <input type="text" name="name" placeholder="Name :" class="form-first-name form-control" id="form-first-name" required>
                                    </div>
                                    <div class="form-group">

                                        <label class="sr-only" for="form-first-name">أسم العائلة :</label>
            <input type="text" title="Family Name" rel="Family Name" placeholder="Family Name" id="lastname" name="lastname"  style="width:100%"  required>
                             ...
                             <input type="hidden" name="landing_name" value="landing1">
