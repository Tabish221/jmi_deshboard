...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" href="{{ URL::asset('/') }}landing-assets/css/landing9.css">
    ...
    <?PHP
            if(empty(session('refeer_cookie'))){
                    session()->put('refeer_cookie', 'landing 9');
                }
        ?>
...
<header><div class="container"><h1 id="logo">JMI Brokers</h1></div></header>
<div class="container">
  <section id="main" class="clearfix">
    <div id="main-inner">
      <h2>إبدأ التداول الان في شركة <span class="en">JMI Brokers</span><br>ذات الخبرة في التداول بالأسواق العالميّة.</h2>
      <h3 class="hide-mobile">شركة <span class="en">JMI Brokers</span> تقدّم لك حساب إسلامي:</h3>
      <ul>
        <li>بدون فوائد ربوية </li>
        <li>بدون عمولات على السحب والايداع</li>
        <li>تداول بالنفط, الاسهم العالمية والعملات</li>
        <li>تداول بإرشاد مدير حساب ومحلل إقتصادي</li>
        <li>توصيات يومية مجانية</li>
      </ul>
    </div>
    <section id="form">
      <h2 class="hide-mobile">أحصل على<br>حساب التدريب <br>بقيمة 10,000$</h2>
      <h2 class="only-mobile">أحصل على<br>حساب التدريب بقيمة 10,000$</h2>
         <form role="form" id="contact_form" action="{{ URL::to('/en/landingpage1') }}" id="landing-form" method="post" class="registration-form do-preloader">
            ...
            <div id="form-inner">
                <div id="divFullName">
                    <input name="name" class="fullName" placeholder="الاسم الأول" type="text"></div>
                <div id="divFullName">
                    <input name="lastname" class="fullName" placeholder="اسم العائلة" type="text"></div>
                <div id="divEmail">
                    <input name="email" class="email" placeholder="البريد الإلكتروني" type="text"></div>
                <div id="divCountry">

                             <input type="hidden" name="landing_name" value="landing9">

                    <select name="country" id="country" class="CountryList"  onchange="countryfun();" >
                ...
                <div id="divPhone">
                        ...
                        <select name="countryCode" id="countryCode"  class="form-control"  style="width:58px !important;padding-right: 0px !important;height: 30px; "    required>


        <option  value="" disabled sected>Code</option>
...
<input type="hidden" name="_token" value="{{ csrf_token() }}">
                ...
                <input name="phone" class="phoneText" placeholder="هاتف" type="text">
                </div>

                <input value="" class="submitButtonMedium" type="submit"  >
