...
.lightbox-medium {
    ...
    <?PHP
            if(empty(session('refeer_cookie'))){
                    session()->put('refeer_cookie', 'landing 4');
                }
        ?>
...
<div id="wrap"> <!-- wrap Start -->
        ...
        <div style="height: 655px; margin-top: -352.5px;" id="main" class="main-height"><!-- main Start -->
            ...
            <div style="height: 655px; background: transparent url('/assets/landing/ShareFortune2_br1_arb2.jpg') no-repeat scroll 0px 0px;" class="img-rep" id="inner"><!--inner Start-->
                
                                
                                                        
                <div id="contact-form"> <!-- contact Start -->
                                        
                    <form id="main-form" action="{{ URL::to('/en/landingpage1') }}" id="landing-form" method="post">
    ...
    <div class="form-line"><!-- lastname -->
        ...
        <div class="input_bg">
            <input type="text" title="Family Name" rel="Family Name" placeholder="Family Name" id="lastname" name="lastname" style="color: rgb(61, 61, 61);" required>
        </div>
    </div>
    ...
    <div class="form-line"><!-- firstname -->
        ...
        <div class="input_bg">
            <input type="text" title="First Name" rel="First Name" id="firstname" placeholder="First Name" name="name" style="color: rgb(61, 61, 61);" required>
        </div>
    </div>
    ...
    <div class="form-line">
        ...
        <label>Phone</label>
        <div class="input_bg">
            <input type="text" title="Phone" rel="Phone" id="phone" placeholder="Phone" name="phone" style="color: rgb(61, 61, 61);" required>
        </div>
    </div>
    ...
    <div class="form-line"><!-- email -->
        ...
        <label>Email</label>
        <div class="input_bg">
            <input type="email" title="Email" rel="Email" placeholder="Email" id="email" name="email" style="color: rgb(61, 61, 61);" required>
        </div>
    </div>
    ...
    <div style="display: none;" class="form-line country"><!-- country -->
        ...
        <div class="input_bg">
            <input type="text" title="الدّولة" rel="الدّولة" value="" id="country" name="country" autocomplete="off" class="ac_input">                          
                             ...
                             <input type="hidden" name="landing_name" value="landing4">
