...
<html>
	<head>
        ...
        <style>
            body
            {
                overflow-x:hidden;background: #e8e8e8;border-bottom: 10px solid #fcc728;
	...
	<body>
        ...
        <?PHP
            if(empty(session('refeer_cookie'))){
              session()->put('refeer_cookie', 'Investing');
                }
        ?>
				<!--
				...
				-->
                  ...
                  <div class="row">
            				<div class="col-sm-12" id="first-level-left" style="background:#0057af;    border-bottom: 5px solid #f8c427;">

            						<iframe src="/en/shownews" style="width: 100%; border: none; height: 35px; padding-top: 6px;"></iframe>

            				</div>
                  </div>
        <div id="bgContainer-" class="row" style=" background: #e8e8e8; ">
            <div id="form" class="col-sm-12 col-md-4">

                <a href="/" style="display:block;max-width:300px;">
                  <img src="https://www.jmibrokers.com/elis/img/fin-logo2.png" style="max-width:300px;">
                </a>
                ...
                <form role="form" id="landing-form" action="{{ URL::to('/en/landingpage3') }}" method="post" >
                    <div class="controls">
                    ...
                    <div class="controls selCtl">
                        <input type="hidden" name="landing_name" value="Investing">
                    ...
                    <div class="controls">
                        <input type="submit" id="send" value="GO TO MAIN PAGE" style="height:40px;">
                    </div>
                </form>
								<div>
										<img src="/assets/m/img/important.png" style=" width: 40px; float: left; margin-right: 18px; ">
										<h3 style="color:#0057af;font-weight: bold;font-size: 14px;text-transform: uppercase;">*The only company that provides <span style="color:#ffc928;display: block;">500,000 $ FiNANCIAL PROTECTION </span> for traders.</h3>

								</div>

			</div>
            <div id="hiddenImg-" class="col-xs-12 col-md-8" style="    margin-bottom: -23px;">
                <img src="/assets/landing/investing-bg.png" style="max-height:700px;width:100%;">
            </div>
            <div id="textSide" class="col-sm-12 col-md-4" style="display:none">
                <h2 class="boldBlue bgOrange">WHY CHOOSE US!</h2>
                <h2 class="boldBlue"><img src ="/assets/m/img/arrow2.png">LICENSED COMPANY</h2>
                <h2 class="boldBlue"><img src ="/assets/m/img/arrow2.png">NO SWAP</h2>
								<h2 class="boldBlue"><img src ="/assets/m/img/arrow2.png">1 PIP FIXED ON MAJOR CURRENCIES</h2>
								<h2 class="boldBlue"><img src ="/assets/m/img/arrow2.png">3 PIP FIXED ON GOLD, SILVER AND DOW JONES</h2>
								<h2 class="boldBlue"><img src ="/assets/m/img/arrow2.png">MOVING SPREAD STARTING 0.1</h2>
								<h2 class="boldBlue"><img src ="/assets/m/img/arrow2.png">ORDER EXCUTION LESS THAN 1S</h2>
								<h2 class="boldBlue"><img src ="/assets/m/img/arrow2.png">NEGATIVE BALANCE PROTECTION</h2>
                ...
                <div class="imgNtext">
                    <h5>JMI Brokers LTD is a licensed Financial Services Provider from Vanuatu Financial Services Commission and authorized to carry business on Dealing in Securities under
                        license number 15010</h5>

														<h5 style="color:#0057af;">*The only company that provides 500,000 $ FiNANCIAL PROTECTION for traders.</h5>
<a href="https://us-central1-madrid-investing.cloudfunctions.net/PostbackCloudFunciton/?token=YWR2ZXJpc2VyX2FmZmlsYXRpb25fdXJs&advertiser=JMI%20BROKERS%20LTD&brand=JMIBrokers&model=CPL&affiliate_id=1&offer_id=&user_id=[user_id]&event_type=FTD&subID=[our_tracking_string]" style="display:none;"></a>
<a href="https://us-central1-madrid-investing.cloudfunctions.net/PostbackCloudFunciton/?token=YWR2ZXJpc2VyX2FmZmlsYXRpb25fdXJs&advertiser=JMI%20BROKERS%20LTD&brand=JMIBrokers&model=CPL&affiliate_id=1&offer_id=&user_id=[user_id]&event_type=Lead&subID=[our_tracking_string]" style="display:none;"></a>
                </div>
        ...
        <script>
            ...
            function countryfun()
            {
				...
				<script async src="https://www.googletagmanager.com/gtag/js?id=UA-221106776-1"></script>
				<script>
				  window.dataLayer = window.dataLayer || [];
				  function gtag(){dataLayer.push(arguments);}
				  gtag('js', new Date());

				  gtag('config', 'UA-221106776-1');
				</script>
...
$.ajax({
	...
	success: function (data){
		console.log('done1');
		 ...
		 $.ajax({
		 	url: 'https://us-central1-madrid-investing.cloudfunctions.net/PostbackCloudFunciton/?token=YWR2ZXJpc2VyX2FmZmlsYXRpb25fdXJs&advertiser=JMI%20BROKERS%20LTD&brand=JMIBrokers&model=CPL&affiliate_id=1&offer_id=&user_id=[user_id]&event_type=Lead&subID=[our_tracking_string]',
		 	dataType: 'jsonp',
			crossDomain: true,
