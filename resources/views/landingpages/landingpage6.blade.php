...
<img height="1" width="1" style="border-style:none;" alt="" src="//googleads.g.doubleclick.net/pagead/viewthroughconversion/926258798/?value=0&amp;guid=ON&amp;script=0"/>
    ...
    <?PHP
            if(empty(session('refeer_cookie'))){
                    session()->put('refeer_cookie', 'landing 6');
                }
        ?>
            ...
            <div class="inner-bg">
                <div class="container">
                    ...
                    <div class="row" style="background-image:url('https://jmibrokers.com/landing-assets/img/mainlanding.jpg') ;background-size: 100%;min-height:566px;">
                        ...
                        <div class="col-sm-8">
                          <!--  <h1 style="background:#002f63;padding:5px;border-radius:10px;margin-bottom:0px;">تداول الفوركس , ذهب , بترول , أسهم بريطانية و أمريكية</h1>
                            <h1 style="background:#002f63;padding:5px;border-radius:10px;margin-top:0px;width:300px;">ابدأ التداول الأن</h1>
                            <br /><br /><br />
        <img src="{{ URL::asset('assets/landing/landingtrend2.png') }}" alt="" class="" />
            ...
            <input type="text" title="Family Name" rel="Family Name" placeholder="Family Name" id="lastname" name="lastname"  style="width:100%"  required>
                             ...
                             <div class="form-group " style="margin-bottom:15px;">   
                              ...
                              <input type="hidden" name="landing_name" value="landing6">
