...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" href="{{ URL::asset('/') }}landing-assets/css/reset.css">
        <link rel="stylesheet" href="{{ URL::asset('/') }}landing-assets/css/landing11.css">
...
<img height="1" width="1" style="border-style:none;" alt="" src="//googleads.g.doubleclick.net/pagead/viewthroughconversion/926258798/?value=0&amp;guid=ON&amp;script=0"/>
    ...
    <?PHP
            if(empty(session('refeer_cookie'))){
                    session()->put('refeer_cookie', 'landing 11');
                }
        ?>
<style>
   ...
   input,select
    {
        height: 35px;
        /* margin-bottom: 24px; */
        background: url(https://jmibrokers.com/landing-assets/img/landing10/icons.png) no-repeat;
...
input[type="submit"  ]
{
    background: #08a500; /* Old browsers */
    background: -moz-linear-gradient(top,  #08a500 0%, #07a200 2%, #0ba303 4%, #099f02 6%, #0ca205 9%, #08a000 11%, #09a402 13%, #07a400 15%, #0aa202 17%, #0ba303 21%, #0a9e00 38%, #0c9b05 49%, #119003 66%, #1a7b0a 100%); /* FF3.6+ */
    background: -webkit-gradient(linear, left top, left bottom, color-stop(0%,#08a500), color-stop(2%,#07a200), color-stop(4%,#0ba303), color-stop(6%,#099f02), color-stop(9%,#0ca205), color-stop(11%,#08a000), color-stop(13%,#09a402), color-stop(15%,#07a400), color-stop(17%,#0aa202), color-stop(21%,#0ba303), color-stop(38%,#0a9e00), color-stop(49%,#0c9b05), color-stop(66%,#119003), color-stop(100%,#1a7b0a)); /* Chrome,Safari4+ */
    background: -webkit-linear-gradient(top,  #08a500 0%,#07a200 2%,#0ba303 4%,#099f02 6%,#0ca205 9%,#08a000 11%,#09a402 13%,#07a400 15%,#0aa202 17%,#0ba303 21%,#0a9e00 38%,#0c9b05 49%,#119003 66%,#1a7b0a 100%); /* Chrome10+,Safari5.1+ */
    background: -o-linear-gradient(top,  #08a500 0%,#07a200 2%,#0ba303 4%,#099f02 6%,#0ca205 9%,#08a000 11%,#09a402 13%,#07a400 15%,#0aa202 17%,#0ba303 21%,#0a9e00 38%,#0c9b05 49%,#119003 66%,#1a7b0a 100%); /* Opera 11.10+ */
    background: -ms-linear-gradient(top,  #08a500 0%,#07a200 2%,#0ba303 4%,#099f02 6%,#0ca205 9%,#08a000 11%,#09a402 13%,#07a400 15%,#0aa202 17%,#0ba303 21%,#0a9e00 38%,#0c9b05 49%,#119003 66%,#1a7b0a 100%); /* IE10+ */
    background: linear-gradient(to bottom,  #08a500 0%,#07a200 2%,#0ba303 4%,#099f02 6%,#0ca205 9%,#08a000 11%,#09a402 13%,#07a400 15%,#0aa202 17%,#0ba303 21%,#0a9e00 38%,#0c9b05 49%,#119003 66%,#1a7b0a 100%); /* W3C */
    filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#08a500', endColorstr='#1a7b0a',GradientType=0 ); /* IE6-9 */


    border:1px solid #117306;
...
<h1 id="logo">Jmi Brokers</h1>
    ...
    <main>
        ...
        <section class="desktop">
            ...
            <h1>تداول الاسواق العالمية بفتح صفقات قصيرة المدى خالية من العمولة والربا</h1>

            <h2>أدخل الان الى عالم المضاربات السريعة, بواسطة <br>3 خطوات بسيطة:</h2>
            ...
            <!--p></p-->
             ...
             <div id="steps_wraper">
                    ...
                    <div class="colom">
                        ...
                        <div class="step-1_text">إفتح حساب إسلامي </div>
                    </div>
                    ...
                    <div class="colom">
                        ...
                        <div class="step-2_text">حدد المبلغ الذي تريد استثماره بالصفقة.</div>
                    </div>
                    ...
                    <div class="colom">
                        ...
                        <div class="step-3_text">حدد إتجاه اسعار السوق </div>
                    </div>
                    
                  </div>

            <strong>إفتح الآن حساب إستثماري شامل وإحصل على :</strong>

            <ul>

                <li class="bullet-1">   توصيا ت تداول مجانية يومية لجوالك  </li>

                <li class="bullet-2">مدير حسابات خاص بك وخبير في سوق الاسهم </li>

                <li class="bullet-3">قنوات تداول متعددة  </li>
                
                <li class="bullet-4">تحقيق أرباح عند إرتفاع او إنخفاض الاسعار </li>
...
<div style="width:1000px;margin:auto;padding-top:50px;">
         ...
         <form role="form" id="contact_form" action="{{ URL::to('/en/landingpage1') }}" id="landing-form" method="post" class="registration-form do-preloader">
            
            <input type="hidden" name="_token" value="{{ csrf_token() }}">

            
                <div id="inner_form" class="clearfix">

                     <p id="form_text" style="display:none;"> إبدأ بكسب المال فورا </p>

                    <input name="name" class="fullName" placeholder="الاسم الأول" type="text">
                    <input name="lastname" class="fullName" placeholder="اسم العائلة" type="text">
                    <select aria-invalid="false" aria-required="true" name="country" id="country"  class="CountryList valid"  onchange="countryfun();">

                             <input type="hidden" name="landing_name" value="landing11">
                    ...
                    <input name="email" class="email" placeholder="البريد الإلكتروني" type="email">
                    <input name="phone" class="phoneText" placeholder="هاتف" type="tel">
     ...
     <select name="countryCode" id="countryCode"  class="countryCode"    required>
        ...
        <option data-countryCode="ZW" value="263"> +263</option>
                    ...
                    <div id="submit_checkbox">
                        <input value="إرسال" class="submitButtonMedium" type="submit"  >
                    </div>
