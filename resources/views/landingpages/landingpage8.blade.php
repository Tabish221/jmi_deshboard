...
<!-- End Facebook Pixel Code -->
    ...
    <?PHP
            if(empty(session('refeer_cookie'))){
                    session()->put('refeer_cookie', 'landing 8');
                }
        ?>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="top-navbar-1">
                    <ul class="nav navbar-nav navbar-right">
                        <li>
                            <span class="li-text">
                                <a style="text-decoration:none;color:#fff;">Contact us</a>
                            </span> 
        ...
        <div class="top-content">
            ...
            <div class="inner-bg">
                <div class="container">
                    ...
                    <h3 class="txt_thin txt_clr_black" style="font-size:22px !important">How <span class="txt_clr_orange txt_regular">can you make money in 30 seconds?</span></h3>
<div class="cript txt_clr_black row"><div class="col-sm-6" ><p  style="font-size:20px !important"><span class="txt_thin number fix">1.&nbsp;</span><span class="txt_light"><br class="tablet">Choose where the graph will go <span class="txt_clr_green uppercase" style="color:green !important;">up </span> or <span class="txt_clr_red uppercase" style="color:red !important;">down</span></span></p></div><div class="col-sm-6" ><p  style="font-size:20px !important"><span class="txt_thin number">2.</span><span class="txt_light">In a few seconds, you'll get <br class="desctop">up to 87% of the profit from the transaction! </span></p></div></div>
...
<div id="widget_chart" class="graphic-wrapper"><div class="graphic"><ul class="graphic-assets"><li><button data-graphic-val="100" data-graphic-rate="80" data-graphic-cur="eur" class="active">USD/EUR</button></li><li><button data-graphic-val="1000" data-graphic-rate="87" data-graphic-cur="usd" class="">AUD/JPY</button></li><li><button data-graphic-val="120" data-graphic-rate="85" data-graphic-cur="usd" class="">Gold</button></li><li><button data-graphic-val="1500" data-graphic-rate="75" data-graphic-cur="usd" class="">Apple</button></li><li><button data-graphic-val="150" data-graphic-rate="87" data-graphic-cur="usd">Oil</button></li></ul><div class="graphic-area"><div class="graphic-view"><div class="graphic-btn-conteiner"><button type="button" data-graphic-direction="up" class="graphic-btn graphic-btn-up">THE CHART WILL GO UP</button><button type="button" data-graphic-direction="down" class="graphic-btn graphic-btn-down">THE CHART WILL GO DOWN</button></div><div class="line"><span class="line-question"><span class="line-question-dot"></span></span></div><div class="inner inner-1"><div class="from"></div><div class="to"></div></div></div><div class="graphic-legend"><div class="graphic-legend-row"><span class="graphic-title">Investment</span><span class="graphic-currency fix eur"></span><input type="text" value="100" maxlength="6" id="invest" class="graphic-value" style="width: 1.8em;"></div><div class="graphic-legend-row"><span class="graphic-title">Percentage of profit</span><span id="rate" class="graphic-value">80</span><span class="graphic-rate">%</span></div><div class="graphic-legend-row last"><span class="graphic-title">Earnings</span><span class="graphic-currency eur"></span><span id="result" class="graphic-value">180</span></div></div><div class="graphic-result"><span class="graphic-result-title">Your prediction was right!</span><span class="graphic-result-small">On the JMI Brokers platform, you would have earned</span><div class="graphic-result-big"><span class="graphic-currency eur"></span><span class="graphic-result-val">180</span></div><button id="" class="graphic-btn graphic-btn-result" onclick="window.location.href='#Form'">Start earning</button></div></div></div></div><!--.form API v 2-->
                        ...
                        <div class="col-sm-6 form-box" style="margin:0 auto;">
                            <div class="form-top">
                                <div class="form-top-left">
                                    ...
                                    <p style="font-size:18px;">Join us and start trading</p>
                                </div>
                            ...
                            <div class="form-bottom" style="text-align:center;">
                                <form role="form" action="{{ URL::to('/en/landingpage1') }}" id="landing-form" method="post" class="registration-form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label class="sr-only" for="form-first-name">Family Name :</label>
            <input type="text" title="Family Name" rel="Family Name" placeholder="Family Name" id="lastname" name="lastname"  style="width:100%"  required>

                                    </div>
                             <div class="form-group " style="margin-bottom:15px;">   

                                      <input type="hidden" name="landing_name" value="landing8">
...
<div class="col-sm-8" style="margin-bottom:15px;margin-right:0px;padding-right:0px;">
                    ...
                    <div style="background:#000;width:100%;height:80px;color:#fff;" id="Form">

                                <p style="font-size:24px !important"> Achieve profits by copying a successful investors trades  </p>
                                <p  style="font-size:24px  !important"  > Learn and Earn  </p>
