...
<html>
	<head>
		...
		<style>
			...
			#bg
			{
				background-image: url("/assets/MImgs/landings/backgroundForex1.png");
			...
			#bg2
			{
				background-image: url("/assets/MImgs/landings/backgroundForex2.png");
				background-repeat: no-repeat;
				background-size: 100% 100%;
				height: 642px;
				padding: 0px;
			...
			#form input::placeholder , .form-controls
			{
				color:black;
				font-size:16px;
			}
      .form-control
      {
        margin-bottom: 15px;
			...
			#footer
			{
				background-image: url("/assets/MImgs/landings/backgroundForex3.png");
				background-repeat: no-repeat;
				background-size: 100% 100%;
				height: auto;
				padding: 20px 50px;
    ...
    ?>
		<div class="row" id="bg">
			<div class="col-xs-6" id="content">
				...
				<p id="start">START</p>
				<p id="forex">FOREX</p>
				<p id="trading">TRADING</p>
				<p id="many">(Gold , Shares , Oil and Currencies)</p>
				<div class="col-sm-6" id="form">
          <form method="post" action="/en/landingpage1">
            <input type="hidden" name="landing_name" value="landing25">
            <input type="hidden" name="_token" value="{{ csrf_token() }}">
					  <button type="submit" class="btn btn-default">Open Live Account</button>
            ...
            <div class="form-group">
              <input type="number" class="form-control" name="phone" id="email" placeholder="Your Phone" required>
				...
				<p id="jmi">www.jmibrokers.com</p>
			</div>
			<div class="col-xs-6" id="bg2">
			</div>
		</div>
		<div class="row" id="footer">
			...
			<div class="col-sm-4 visible" id="blueText">
				<p>Why to Make </p>
				<p id="arrowText"><img src="/assets/MImgs/landings/arrow2.png"> BUSINESS<img src="/assets/MImgs/landings/arrow1.png"></p>
				<p>With JMI?? </p>
			</div>
			<div class="col-sm-4 visible">
				<p>-Low minimum </p>
				<p>-deposit of $100 </p>
				<p>-Deposit and Withdraw without fees </p>
			</div>
			<div class="col-xs-12 hidden" id="blueText">
				<p>Why to Make </p>
				<p id="arrowText"><img src="/assets/MImgs/landings/arrow2.png"> BUSINESS<img src="/assets/MImgs/landings/arrow1.png"></p>
				<p>With JMI?? </p>
			</div>
