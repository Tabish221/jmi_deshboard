...
<img height="1" width="1" style="border-style:none;" alt="" src="//googleads.g.doubleclick.net/pagead/viewthroughconversion/926258798/?value=0&amp;guid=ON&amp;script=0"/>
    ...
    <?PHP
            if(empty(session('refeer_cookie'))){
                    session()->put('refeer_cookie', 'landing 2');
                }
        ?>
            ...
            <div class="inner-bg">
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8">
                            <h1 style="background:#0053af;padding:5px;border-radius:10px;margin-bottom:0px;">Trade Forex, Gold, Oil , Uk Shares and US Shares</h1>
                            <h1 style="background:#002f63;padding:5px;border-radius:10px;margin-top:0px;width:300px;">Start Trading Now</h1>
                            <br />


                           
                              <ul style="text-align:left;font-size:18px">
                                   <i class="fa fa-check-circle" aria-hidden="true" style="color:#fff;"> ECN Accounts</i>

                                  <i class="fa fa-check-circle" aria-hidden="true" style="color:#fff;"> Fixed Accounts</i>

                                  <i class="fa fa-check-circle" aria-hidden="true" style="color:#fff;"> Scalping Trading</i>

                                  <i class="fa fa-check-circle" aria-hidden="true" style="color:#fff;"> Expert Advisors</i>

                                  <i class="fa fa-check-circle" aria-hidden="true" style="color:#fff;"> High Frequency Trading (HFT)</i>

                                  <i class="fa fa-check-circle" aria-hidden="true" style="color:#fff;"> Branded White label form MetaQuote</i>


                                 
                                  <i class="fa fa-check-circle" aria-hidden="true" style="color:#fff;"> Zero Transactions Fees ( Deposits & Withdrawals )</i>

                                  <i class="fa fa-check-circle" aria-hidden="true" style="color:#fff;"> Leverage up to 1:500</i>


                                </ul>

                            <br />
        <img src="{{ URL::asset('assets/landing/landingtrend2.png') }}" alt="" class="" />
                        ...
                        <div class="col-sm-4 form-box" style="margin:0 auto;">
                            <div class="form-top">
                                <div class="form-top-left">
                                    ...
                                    <p style="font-size:18px;">Register Now</p>
                                </div>
            ...
            <input type="text" title="Family Name" rel="Family Name" placeholder="Family Name" id="lastname" name="lastname"  style="width:100%"  required>
                             ...
                             <input type="hidden" name="landing_name" value="landing2">
...
<div class="col-sm-8" style="margin-bottom:15px;margin-right:0px;padding-right:0px;">
        ...
        <div class="row mrtb40" style="display:none;"  >
...
<h2 class="text-center">JMIBrokers LTD Head Quarter </h2><br />
  <div style="width:60%;float:left;">
        <div id="googleMap1" style="width:100%;height:300px;float:left;"></div><br />
        <div style="float:left;margin:0 15px;text-align:left;">
                <h5>Address Details</h5>
                <p>
                    Wall Street - Financial District Executive Suites
                    <br />
                    30 Broad Street<br />
                    14th Floor <br />
                    New York City, NY 10004 <br />
                    United States
        ...
        <div style="float:left;margin:0 15px;text-align:left;">
                ...
                <h5>Phone no:<span class="span-no"> +1-866-565-2126</span></h5>

                <h5>Fax no: &nbsp;&nbsp;&nbsp;<span class="span-no"> +1-866-568-3978</span></h5>

                <div class="speacer10"></div>
        </div>
        <div style="float:left;margin:0 15px;text-align:left;">
                <h5>Useful contacting e-mails</h5>
...
<div class="row col-sm-12" style="margin-top:20px;">
                    ...
                    <h2 class="text-center">JMIBrokers LTD  Regional Office </h2><br />
  <div class="col-sm-6" style="width:50%;float:left;">
        ...
        <div style="float:left;margin:0 15px;text-align:left;">
                ...
                <div class="speacer20"></div>
                    <h5>Phone no:<span class="span-no">  +971 44096705</span></h5>
                    <h5>Fax:<span class="span-no pl40">  +971 44096740</span></h5>
                    <h5>E-mail: &nbsp;&nbsp;&nbsp;&nbsp; <a href="mailto:support@jmibrokers.com">support@jmibrokers.com.</a></h5>
...
<div class="row col-sm-12" style="margin-top:20px;">
  ...
  <div style="width:60%;float:left;">
        ...
        <div style="float:left;margin:0 15px;">
                ...
                <div class="speacer20"></div>
                <h5>Phone no:<span class="span-no"> +225166835</span></h5>

                <h5>E-mail: &nbsp;&nbsp;&nbsp;&nbsp; <a href="mailto:egypt.office@jmibrokers.com">egypt.office@jmibrokers.com</a></h5>
