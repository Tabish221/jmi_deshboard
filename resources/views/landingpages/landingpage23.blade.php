...
<html>
	<head>
		...
		<style>
			...
			#bg
			{
				background-image: url("/assets/MImgs/landings/background.png");
			...
			{
				padding:0px;
				background-image: url("/assets/MImgs/landings/bull.png");
				background-repeat: no-repeat;
				background-size: 100% 100%;
        ...
        padding-top: 38px;
			...
			#form button , #form input ,#form2 button , #form2 input , #form select , #form2 select
			{
				border-radius:0px;
				width:90%;
				margin:auto;
			}
			#form input::placeholder , #form2 input::placeholder , .form-control
			{
			...
			{
				text-align: center;
				background-image: url("/assets/MImgs/landings/footer.png");
				background-repeat: no-repeat;
				background-size: 100% 100%;
				height:auto;
				padding: 10px;
			...
			@media only screen and (max-width: 768px) {
				#bg
				{
					background-image: url("/assets/MImgs/landings/background2.png");
					height:850px;
				}
				#form
				{
    ...
    ?>
		<div class="row" id="bg">
			<div class="col-sm-12" id="logo">
				<img src="/assets/MImgs/landings/logo.png">
			</div>
			<div class="col-sm-4" id="form">
				<form method="post" action="/en/landingpage1">
          <input type="hidden" name="landing_name" value="landing23">
          <input type="hidden" name="_token" value="{{ csrf_token() }}">
			...
			<div class="col-sm-8" id="pic">
				<p id="absText">
					<img class="arrowIcon" src="data:image/svg+xml;base64," />
					<span id="buySpan">BUYING</span>
					<span id="andSpan"> & </span>
					<span id="sellSpan">SELLING</span>
					<span id="foreignSpan">Foreign Exchange</span>
					<span id="joinSpan">Join Our Team</span>
				</p>
			</div>
			<div class="col-sm-12" id="pic2">
				<p id="absText2">
					<span id="buySpan">BUYING</span>
					<span id="andSpan"> & </span>
					<span id="sellSpan">SELLING</span>
					<span id="foreignSpan">Foreign Exchange</span>
					<span id="joinSpan">Join Our Team</span>
					<img class="arrowIcon" src="data:image/svg+xml;base64," />
				</p>
				<img id="imgCenter" src="/assets/MImgs/landings/bull.png">
			</div>
      <div class="col-sm-4" id="form2">
		...
		<div id="text">
			<hr>
			<h2>WHAT IS BUYING AND SELLING IN FOREX?</h2>
			<h4>Buying and selling in forex is speculating on the upward and downward price movement of currency pair, with the hopes of making a profit. All forex trading involves buying one currency and selling another, which is why it is quoted in pairs. You would buy the pair if you exoected the base currency to strengthen against the quote currency, and you would sell if you expected it to do the opposite.</h4>
			<p>www.jmibrokers.com</p>
		</div>
	</body>
	<script>
