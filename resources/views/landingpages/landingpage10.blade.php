...
<html lang="en" dir="rtl">
    ...
    <head>
        ...
        <link rel="stylesheet" href="{{ URL::asset('/') }}landing-assets/css/landing10.css">
...
<img height="1" width="1" style="border-style:none;" alt="" src="//googleads.g.doubleclick.net/pagead/viewthroughconversion/926258798/?value=0&amp;guid=ON&amp;script=0"/>
      ...
      <?PHP
            if(empty(session('refeer_cookie'))){
                    session()->put('refeer_cookie', 'landing 10');
                }
        ?>
    ...
    <main>
        <div id="container">
            ...
            <div class="mobile_text">
                <h2>بالطبع, تملك ما يجعلك متداولا ناجحًا!</h2>
                <ul>
                    <li>ساعة او ساعتين فقط اسبوعيًا تكفيك لتتمكن من شراء وبيع العملات</li>
                    <li>الخبرة غير مطلوبة بشكل حتمي, خبرائنا سوف يهتموا بتعليمك كل ما تحتاج معرفته لتكسب</li>
                </ul>
            </div>
            ...
            <div class="desktop_text">
                <div>
                    <section>
                        <h3>
                            بالطبع, تملك ما يجعلك متداولا ناجحًا!                        </h3>
                        <ul>
                            <li>ساعة او ساعتين فقط اسبوعيًا تكفيك لتتمكن من شراء وبيع العملات</li>
                            <li>الخبرة غير مطلوبة بشكل حتمي, خبرائنا سوف يهتموا بتعليمك كل ما تحتاج معرفته لتكسب</li>
                            <li class="hide_english">Easy to trade- a couple of hours a week are enough!</li>
                        </ul>
                        <p class="hide_arabic">لماذا تعيش بدخل واحد فقط, طالما يمكنك جني الكثير والكثير من المال؟! <br>
تحكم في مواردك المالية مع JMI Brokers من<br>
 خلال التداول في العملات, السلع, المؤشرات وعقود الفروقات!</p>
                    </section>
                </div>
            </div>
         ...
         <form role="form" id="contact_form" action="{{ URL::to('/en/landingpage1') }}" id="landing-form" method="post" class="registration-form do-preloader">
            ...
            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                ...
                <div id="inner_form" class="clearfix">
                     ...
                     <p id="form_text"> إبدأ بكسب المال فورا </p>
                    ...
                    <select aria-invalid="false" aria-required="true" name="country" id="country"   class="CountryList valid"  onchange="countryfun();">
                             ...
                             <input type="hidden" name="landing_name" value="landing10">
