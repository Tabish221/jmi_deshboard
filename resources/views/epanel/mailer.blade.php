            ...
            <div class="">
                ...
                <div class="row">          
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                <td colspan="5"><a class="btn btn-success" href="/en/epanel/mailer/exportall">Export All</a></td>
                                <td colspan="2">
                                    {!! Form::open(['url'=>'en/epanel/mailer/','id'=>'DeleteSelected','method'=>'delete','onsubmit' => 'return confirmDelete()']) !!}
                            ...
                            <?PHP  $i=1;$titlearr=['Mr','Mrs','Miss']; ?>
                                @foreach($mails as $mail)
                                    ...
                                    <tr>
                                        ...
                                        <td>{!! $mail->name !!}</td>
                                        <td>
                                        {!! Form::open(['url'=>'en/epanel/mailer/'.$mail->id,'method'=>'delete','onsubmit' => 'return confirmDelete()']) !!}
...
$('tbody tr td input.checkbox').click(function(){
   ...
   $('#DeleteSelected').attr('action', '/en/epanel/mailer/'+Arr);
