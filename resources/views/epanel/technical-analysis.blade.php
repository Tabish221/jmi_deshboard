...
@if(count($posts)>0)
            ...
            <div class="">
                ...
                <div class="row">          
                    <table class="table table-bordered">
                        <thead>
                            <tr><td colspan="7">
                                    {!! Form::open(['url'=>'en/epanel/technical-analysis/','id'=>'DeleteSelected','method'=>'delete','onsubmit' => 'return confirmDelete()']) !!}
                        ...
                        <tbody>
                            <?PHP  $i=1;$posttypearr=['Error','GBP/USD','EUR/USD','USD/JPY','AUD/USD','GOLD','OIL']; ?>
                                @foreach($posts as $post)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-success" href="/en/epanel/technical-analysis/status/{!! $post->id !!}" >@if ($post->technicalstatus==1) Unpublish @endif  @if ($post->technicalstatus==0) Publish  @endif</a>
                                        <button type="button" class="btn btn-success" data-toggle="modal" data-target="#edit{!! $post->id !!}" >Edit</button>


                                        {!! Form::open(['url'=>'en/epanel/technical-analysis/'.$post->id,'method'=>'delete','onsubmit' => 'return confirmDelete()','style'=>'display:inline;',]) !!}
        ...
        {!! Form::open(['url'=>'en/epanel/update-technical-analysis/'.$post->id]) !!}
...
$('tbody tr td input.checkbox').click(function(){
   ...
   $('#DeleteSelected').attr('action', '/en/epanel/technical-analysis/'+Arr);
