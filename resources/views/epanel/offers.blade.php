...
@if(count($posts)>0)
            ...
            <div class="">
                ...
                <div class="row">          
                    <table class="table table-bordered">
                        <thead>
                            <tr><td colspan="7">
                                    {!! Form::open(['url'=>'en/epanel/offers/','id'=>'DeleteSelected','method'=>'delete','onsubmit' => 'return confirmDelete()','files'=>true]) !!}
                                ...
                                @foreach($posts as $post)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-success" href="/en/epanel/offers/status/{!! $post->id !!}" >@if ($post->offerstatus==1) Unpublish @endif  @if ($post->offerstatus==0) Publish  @endif</a>
                                        <button type="button" class="btn btn-success" data-toggle="modal" data-target="#edit{!! $post->id !!}" >Edit</button>


                                        {!! Form::open(['url'=>'en/epanel/offers/'.$post->id,'method'=>'delete','onsubmit' => 'return confirmDelete()','style'=>'display:inline;',]) !!}
        ...
        {!! Form::open(['url'=>'en/epanel/update-offers/'.$post->id]) !!}
...
$('tbody tr td input.checkbox').click(function(){
   ...
   $('#DeleteSelected').attr('action', '/en/epanel/offers/'+Arr);
